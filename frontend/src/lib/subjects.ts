...
export const baseSubjects: Subject[] = [
  {
    ...
    quiz: [
      ...
      },
      {
        type: "mcq",
        topic: "Language Devices",
        question: "An emotive appeal mainly aims to:",
        options: [
          "Make the reader feel a strong emotion",
          "Present only statistics",
          "Remove all bias from an argument",
          "Describe a setting in a narrative",
        ],
        answer: "Make the reader feel a strong emotion",
      },
      {
        type: "short",
        topic: "Argument Analysis",
        question: "What is a contention?",
        acceptedAnswers: [
      ...
      },
      {
        type: "mcq",
        topic: "Essay Writing",
        question: "A topic sentence should primarily:",
        options: [
          "Introduce the paragraph’s main idea",
          "Summarise the entire essay",
          "Repeat the prompt word-for-word",
          "List quotes without analysis",
        ],
        answer: "Introduce the paragraph’s main idea",
      },
      {
        type: "short",
        topic: "Language Devices",
        question: "Name one persuasive technique that involves evidence or facts.",
        acceptedAnswers: [
          "statistics",
          "facts",
          "evidence",
      ...
      },
      {
        type: "mcq",
        topic: "Argument Analysis",
        question: "Tone in persuasive writing refers to:",
        options: [
          "The writer’s attitude toward the issue and audience",
          "Only the length of sentences",
          "The number of paragraphs used",
          "Whether the text rhymes",
        ],
        answer: "The writer’s attitude toward the issue and audience",
      },
    ],
  },
  {
