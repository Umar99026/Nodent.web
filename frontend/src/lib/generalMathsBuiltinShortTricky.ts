...
const BANK: Question[] = [
  ...
  short("Recursion and financial modelling", "Perpetuity: annual payment $\\$4\\,800$ at $5\\%$ p.a. Find present value (nearest dollar).", ["96000","$96000","96000.0"], 2),
  ...
  short("Networks and decision mathematics", "Tasks: A(3)→B(2)→D(4) and A→C(1)→D. Critical path duration?", ["9","9.0"], 2),
