/**
 * Tricky short-answer practice bank (146 questions). Generated — edit in place if needed.
...
const BANK: Question[] = [
  ...
  short("Exponential and logarithmic functions", "Evaluate $\\log_2(64)$.", ["6","6.0"], 2),
  ...
  short("Sampling and sample proportions", "Sample: $18$ successes in $80$ trials. $\\hat{p} = $ ? (3 d.p.)", ["0.225",".225"], 2),
  short("Confidence intervals for proportions", "95% confidence uses $z \\approx$ ? (2 d.p.)", ["1.96","1.960"], 2),
  ...
  short("Exponential and logarithmic functions", "Solve $5^x = 625$ for $x$.", ["4","4.0"], 2),
  short("Circular functions", "Exact value: $\\cos\\!\\left(\\dfrac{2\\pi}{3}\\right)$ (fraction).", ["-1/2","-0.5","-.5"], 2),
  short("Algebra and equations", "Solve $2x + y = 11$ and $x - y = 1$. Find $x$.", ["4","4.0"], 2),
  ...
  short("Integral calculus", "Evaluate $\\displaystyle\\int_0^2 3x\\,dx$.", ["6","6.0"], 2),
  short("Applications of integration", "Velocity $v(t) = 4t$. Displacement from $t = 0$ to $t = 3$.", ["18","18.0"], 2),
  ...
  short("Circular functions", "Smallest positive solution to $\\sin x = \\dfrac{\\sqrt{2}}{2}$ on $[0,2\\pi)$ in radians: $\\dfrac{\\pi}{k}$. Find $k$.", ["4","4.0"], 2),
  short("Algebra and equations", "Solve $x^2 - 9 > 0$. Smallest integer satisfying it?", ["4","-4"], 2),
  ...
  short("Applications of differentiation", "$s(t) = t^3 - 6t$. Velocity at $t = 2$.", ["6","6.0"], 2),
  short("Integral calculus", "$\\displaystyle\\int \\cos x\\,dx$ includes which function? (one word)", ["sin","sin(x)","sine"], 2),
  short("Applications of integration", "Average value of $f(x) = 8$ on $[2,6]$ is?", ["8","8.0"], 2),
  short("Discrete random variables", "Invalid probability: $P(A) = -0.1$. Is this allowed? yes or no.", ["no","No"], 2),
  ...
  short("Integral calculus", "Particle: $v(t)=3t^2-2$. Displacement from $t=1$ to $t=2$?", ["5","5.0"], 2),
  short("Applications of integration", "PDF $f(x)=\\dfrac{2x}{9}$ on $[0,3]$. Find $P(X<1.5)$.", ["0.25",".25","1/4"], 2),
  short("Discrete random variables", "Game: win \\$4 with prob 0.2, lose \\$1 otherwise. Expected profit per play?", ["0.2","0.20",".2"], 2),
  ...
  short("Sampling and sample proportions", "Survey 40% yes from $n=25$. Is $\\hat{p}=0.40$? yes or no.", ["yes","Yes"], 2),
  ...
  short("Exponential and logarithmic functions", "Solve $2^{x+1} = 8$ for $x$.", ["2","2.0"], 2),
  short("Circular functions", "$\\tan\\!\\left(\\dfrac{\\pi}{4}\\right) = $ ?", ["1","1.0"], 2),
  short("Algebra and equations", "Solve $3^{2x} = 81$ for $x$.", ["2","2.0"], 2),
  ...
  short("Confidence intervals for proportions", "90% confidence uses $z \\approx$ ? (2 d.p.)", ["1.645","1.65"], 2),
  short("Functions and transformations", "$g(x) = x^2$ with domain $x \\geq 0$. Is $g$ one-to-one? yes or no.", ["yes","Yes"], 2),
  ...
  short("Applications of differentiation", "$f(x) = x^3 - 3x$. At $x = 2$, is $f$ increasing or decreasing? (one word)", ["increasing","Increasing"], 2),
  short("Integral calculus", "Evaluate $\\displaystyle\\int_0^{\\pi/2} \\cos x\\,dx$.", ["1","1.0"], 2),
  short("Applications of integration", "Constant velocity $v(t) = 5$ m/s. Displacement from $t = 0$ to $t = 4$ s?", ["20","20.0"], 2),
  ...
  short("Functions and transformations", "Composite: $f(x)=x+1$, $g(x)=x^2$. Find $(f\\circ g)(2)$.", ["5","5.0"], 2),
  ...
  short("Discrete random variables", "Binomial: $n=4$, $p=0.5$. $P(X=2)$ as fraction?", ["3/8","0.375",".375"], 2),
  ...
  short("Applications of integration", "Evaluate $\\displaystyle\\int_0^{\\pi} \\sin x\\,dx$.", ["2","2.0"], 2),
  short("Discrete random variables", "$E(X)=\\sum x\\,P(X=x)$. If always $X=3$, then $E(X)=$ ?", ["3","3.0"], 2),
  short("Continuous random variables", "For PDF, $f(x)\\geq 0$ everywhere. True or false?", ["true","True","yes"], 2),
  short("The normal distribution", "Bell-shaped, symmetric about the ___ . (one word)", ["mean","Mean","mu"], 2),
  short("Sampling and sample proportions", "$\\hat{p}=0.12$ from $n=50$. Number of successes?", ["6","6.0"], 2),
  short("Confidence intervals for proportions", "Margin of error shrinks when $n$ increases — true or false?", ["true","True","yes"], 2),
