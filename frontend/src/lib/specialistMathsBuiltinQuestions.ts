/**
 * Tricky short-answer practice bank (70 questions). Generated — edit in place if needed.
...
const BANK: Question[] = [
  ...
  short("Differential calculus", "Implicit: $x^2 + y^2 = 25$. At $(3,4)$, $\\dfrac{dy}{dx} = -\\dfrac{3}{k}$. Find $k$.", ["4","4.0"], 2),
  ...
  short("Differential equations", "Separable: $\\dfrac{dy}{dx} = 2y$. Growth or decay? (one word)", ["growth","Growth"], 2),
  short("Kinematics", "$s(t) = t^3 - 6t$. Velocity at $t = 1$.", ["-3","-3.0"], 2),
  ...
  short("Vector calculus", "$\\mathbf{r}(t) = (t^2, t)$. Velocity vector at $t = 1$ has $x$-component?", ["2","2.0"], 2),
  ...
  short("Differential equations", "Verify: $y = Ce^{2x}$ satisfies $y' = 2y$. Derivative $y'$ equals $2y$ when $C$ is any constant — true or false?", ["true","True","yes"], 2),
  ...
  short("Logic and proof", "Statement: 'All primes are odd.' One counterexample (smallest prime)?", ["2","2.0"], 2),
  short("Complex numbers and algebra", "Polar: $z = 2\\operatorname{cis}\\!\\left(\\dfrac{\\pi}{3}\\right)$. Real part?", ["1","1.0"], 2),
  ...
  short("Kinematics", "Particle at rest when $v(t) = 0$. For $v(t) = 2t - 8$, find $t$.", ["4","4.0"], 2),
  ...
  short("Differential equations", "Tank: $\\dfrac{dV}{dt}=-0.2V$, $V(0)=500$. $V(5)$ nearest litre?", ["184","183.94","184.0"], 2),
  ...
  short("Integral calculus", "Solid: region under $y=x^2$ from 0 to 2 rotated about $x$-axis. Setup factor $\\pi\\int_0^2 x^4\\,dx$ — integrand power of $x$ is?", ["4","4.0"], 2),
  ...
  short("Logic and proof", "Statement: 'If $n^2$ is even then $n$ is even.' Contrapositive starts: 'If $n$ is odd then …' Complete: $n^2$ is ___ ?", ["odd","Odd"], 2),
