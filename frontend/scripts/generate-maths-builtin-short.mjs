...
const general = [
  ...
  {
    topic: "Recursion and financial modelling",
    q: "For a perpetuity with annual payment $\\$4\\,800$ at $5\\%$ p.a., find the present value (nearest dollar).",
...
const methods = [
  ...
  { topic: "Circular functions", q: "Find the smallest positive solution to $\\sin x = \\frac{\\sqrt{2}}{2}$ on $[0,2\\pi)$. The answer is $\\frac{\\pi}{k}$. Find $k$.", a: ["4", "4.0"] },
  ...
  { topic: "Applications of differentiation", q: "For $s(t) = t^3 - 6t$, find the velocity at $t = 2$.", a: ["6", "6.0"] },
  ...
  { topic: "Applications of integration", q: "For $v(t) = 4t$, find the displacement from $t = 0$ to $t = 3$.", a: ["18", "18.0"] },
  ...
  { topic: "Sampling and sample proportions", q: "In a sample, $18$ successes in $80$ trials. Find $\\hat{p}$ (3 d.p.).", a: ["0.225", ".225"] },
...
const methodsTopicBoost = [
  ...
  { topic: "Applications of integration", q: "A particle moves with $v(t) = 5$ m/s. Find the displacement from $t = 0$ to $t = 4$ s.", a: ["20", "20.0"] },
  ...
  { topic: "Functions and transformations", q: "Given $f(x)=x+1$ and $g(x)=x^2$, find $(f\\circ g)(2)$.", a: ["5", "5.0"] },
  ...
  { topic: "Discrete random variables", q: "For $n=4$, $p=0.5$, find $P(X=2)$ as a fraction.", a: ["3/8", "0.375", ".375"] },
...
const specialist = [
  ...
  { topic: "Logic and proof", q: "The statement 'All primes are odd' is false. Give the smallest counterexample.", a: ["2", "2.0"] },
  ...
  { topic: "Complex numbers and algebra", q: "For $z = 2\\operatorname{cis}\\!\\left(\\dfrac{\\pi}{3}\\right)$, find the real part.", a: ["1", "1.0"] },
  ...
  { topic: "Differential calculus", q: "For $x^2 + y^2 = 25$, at $(3,4)$ find $k$ if $\\dfrac{dy}{dx} = -\\dfrac{3}{k}$.", a: ["4", "4.0"] },
  ...
  { topic: "Differential equations", q: "For $\\dfrac{dy}{dx} = 2y$, is the solution growth or decay? (one word)", a: ["growth", "Growth"] },
  { topic: "Differential equations", q: "Does $y = Ce^{2x}$ satisfy $y' = 2y$ for any constant $C$? (true or false)", a: ["true", "True", "yes"] },
  ...
  { topic: "Kinematics", q: "For $s(t) = t^3 - 6t$, find the velocity at $t = 1$.", a: ["-3", "-3.0"] },
  { topic: "Kinematics", q: "$v(t) = 6t - 4$. Acceleration at $t = 2$.", a: ["6", "6.0"] },
  { topic: "Kinematics", q: "For $v(t) = 2t - 8$, find the time $t$ when the particle is at rest ($v = 0$).", a: ["4", "4.0"] },
  ...
  { topic: "Vector calculus", q: "For $\\mathbf{r}(t) = (t^2, t)$, the velocity vector at $t = 1$ has $x$-component?", a: ["2", "2.0"] },
...
const generalUnique = [
  ...
  { topic: "Networks and decision mathematics", q: "In a project network, tasks follow A(3)→B(2)→D(4) and A→C(1)→D. What is the critical path duration?", a: ["9", "9.0"] },
...
const methodsUnique = [
  ...
  { topic: "Integral calculus", q: "Evaluate $\\displaystyle\\int_0^2 t^2\\,dt$.", a: ["8/3", "2.67", "2.667"] },
  { topic: "Applications of integration", q: "PDF $f(x)=\\dfrac{2x}{9}$ on $[0,3]$. Find $P(X<1.5)$.", a: ["0.25", ".25", "1/4"] },
  { topic: "Discrete random variables", q: "You win \\$4 with probability $0.2$ and lose \\$1 otherwise. Expected profit per play?", a: ["0.2", "0.20", ".2"] },
...
const specialistUnique = [
  ...
  { topic: "Differential equations", q: "A tank drains so $\\dfrac{dV}{dt}=-0.2V$ with $V(0)=500$. Find $V(5)$ to the nearest litre.", a: ["184", "183.94", "184.0"] },
  ...
  { topic: "Logic and proof", q: "For 'If $n^2$ is even then $n$ is even', the contrapositive starts 'If $n$ is odd then …'. Complete: $n^2$ is ___ ?", a: ["odd", "Odd"] },
  ...
  { topic: "Integral calculus", q: "A solid is formed when the region under $y=x^2$ from 0 to 2 is rotated about the $x$-axis. In $\\pi\\int_0^2 x^4\\,dx$, what is the power of $x$ in the integrand?", a: ["4", "4.0"] },
  { topic: "Differential equations", q: "Logistic-style: carrying capacity 1000, $P(0)=100$. Long-term $P$ approaches?", a: ["1000", "1000.0"] },
  { topic: "Kinematics", q: "A particle has velocity $v(t)=3t^2-2$. Find the displacement from $t=1$ to $t=2$.", a: ["5", "5.0"] },
...
assertCount("specialist", specialistAll, 71);
