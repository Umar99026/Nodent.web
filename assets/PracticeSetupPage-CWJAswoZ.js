import{Ft as e,Ht as t,Lt as n,Vt as r,Xt as i,Yt as a,Zt as ee,en as o,n as s,rn as c}from"./utils-BxH6ecno.js";import{n as te}from"./AuthContext-Dn_H_4vz.js";import{t as ne}from"./AppShell-BLt2t_Qm.js";import{a as l,c as u,d,f,g as p,h as m,l as re,m as h,n as g,p as _,u as v}from"./practiceQuestions-C5b5svgo.js";import{t as y}from"./RichQuestionContent-C5DR3JUC.js";import{c as ie,h as b}from"./input-92bjCOCB.js";import{t as ae}from"./book-open-J9d0m3sP.js";import{a as x,i as S,n as C,r as w,t as T}from"./select-CpgQU3WP.js";import{t as oe}from"./loader-circle-CxNt_Ebv.js";import{a as se,n as E,o as D,t as O}from"./card-DU9S2ItA.js";import{t as k}from"./badge-W2Ms0Sm-.js";import{t as A}from"./subjects-CGCfidCf.js";var ce=b(`arrow-right`,[[`path`,{d:`M5 12h14`,key:`1ays0h`}],[`path`,{d:`m12 5 7 7-7 7`,key:`xquz4c`}]]),le=b(`sparkles`,[[`path`,{d:`M11.017 2.814a1 1 0 0 1 1.966 0l1.051 5.558a2 2 0 0 0 1.594 1.594l5.558 1.051a1 1 0 0 1 0 1.966l-5.558 1.051a2 2 0 0 0-1.594 1.594l-1.051 5.558a1 1 0 0 1-1.966 0l-1.051-5.558a2 2 0 0 0-1.594-1.594l-5.558-1.051a1 1 0 0 1 0-1.966l5.558-1.051a2 2 0 0 0 1.594-1.594z`,key:`1s2grr`}],[`path`,{d:`M20 2v4`,key:`1rf3ol`}],[`path`,{d:`M22 4h-4`,key:`gwowj6`}],[`circle`,{cx:`4`,cy:`20`,r:`2`,key:`6kqj1y`}]]),j=c(o(),1),M=e();function ue({markdown:e,className:t}){return(0,M.jsx)(`div`,{className:s(`curriculum-overview rounded-2xl border border-black/10 bg-gradient-to-b from-white to-slate-50/80`,`px-6 py-9 shadow-sm sm:px-10 sm:py-12`,`text-[#0b0f19]`,`[&_.katex-error]:hidden`,t),children:(0,M.jsx)(y,{text:e,preferMarkdown:!0,overviewMode:!0})})}var N=`### Types of data
...
`,L=e=>String(e??``).trim().toLowerCase().replace(/\s+/g,` `),R={statistics:`Data analysis`,"data analysis, probability and statistics":`Data analysis`,finance:`Recursion and financial modelling`,sequences:`Recursion and financial modelling`,recursion:`Recursion and financial modelling`,matrices:`Matrices`,matrix:`Matrices`,networks:`Networks and decision mathematics`,graphs:`Networks and decision mathematics`,"discrete mathematics":`Matrices`,"algebra, number and structure":`Recursion and financial modelling`,"functions, relations and graphs":`Data analysis`,"space and measurement":`Data analysis`};function z(e,t,n){return`${e}

**Area:** ${t}

---

${n}`}var B={"Data analysis":z(`## Data analysis`,`Data analysis`,N),"Recursion and financial modelling":z(`## Recursion and financial modelling`,`Recursion and financial modelling`,`**Sequences** where each term depends on the previous term — used heavily in **finance**, loans, and investments.

${P}`),Matrices:z(`## Matrices`,`Matrices`,`Organising numbers in **arrays** to model transitions, networks, and systems.

${F}`),"Networks and decision mathematics":z(`## Networks and decision mathematics`,`Networks and decision mathematics`,`**Graphs**, **paths**, **optimisation**, and **scheduling**.

${I}`)};function V(e){let t=String(e??``).trim();if(!t)return null;let n=p(t);if(Object.prototype.hasOwnProperty.call(B,n))return B[n];let r=L(n),i=R[r]??R[L(t)];if(i)return B[i]??null;for(let e of h)if(L(e)===r||L(e)===L(t))return B[e];return null}var H=`A function takes an input $x$ and gives exactly one output $y$: $y = f(x)$.
...
`,W=`Calculus studies **change** (differentiation) and **accumulation** (integration).
...
`,ge=`### Definite integrals and area
...
`,ve=`### Continuous random variables
...
`,xe=`### Confidence intervals for proportions
...
${n}`}var J={"Functions and transformations":q(`## Functions and transformations`,`Functions, relations and graphs`,H),"Polynomial, power and rational functions":q(`## Polynomial, power and rational functions`,`Functions, relations and graphs`,U),"Exponential and logarithmic functions":q(`## Exponential and logarithmic functions`,`Functions, relations and graphs`,de),"Circular functions":q(`## Circular functions`,`Functions, relations and graphs`,fe),"Algebra and equations":q(`## Algebra and equations`,`Algebra`,pe),"Differential calculus":q(`## Differential calculus`,`Calculus`,W),"Applications of differentiation":q(`## Applications of differentiation`,`Calculus`,me),"Integral calculus":q(`## Integral calculus`,`Calculus`,he),"Applications of integration":q(`## Applications of integration`,`Calculus`,ge),"Discrete random variables":q(`## Discrete random variables`,`Probability and statistics`,_e),"Continuous random variables":q(`## Continuous random variables`,`Probability and statistics`,ve),"The normal distribution":q(`## The normal distribution`,`Probability and statistics`,ye),"Sampling and sample proportions":q(`## Sampling and sample proportions`,`Probability and statistics`,be),"Confidence intervals for proportions":q(`## Confidence intervals for proportions`,`Probability and statistics`,xe)};function Se(e){let t=String(e??``).trim();if(!t)return null;let n=_(t);if(Object.prototype.hasOwnProperty.call(J,n))return J[n];let r=G(n),i=K[r]??K[G(t)];if(i)return J[i]??null;for(let e of d)if(G(e)===r||G(e)===G(t))return J[e];return null}var Ce=`### Logic and statements
...
`,Me=`### Vector functions and motion
...
${Ce}`),"Complex numbers and algebra":Z(`## Complex numbers and algebra`,`Algebra, number and structure`,`Complex arithmetic, polar form, De Moivre’s theorem, and roots.

${Te}`),"Functions, relations and graphs":Z(`## Functions, relations and graphs`,`Functions, relations and graphs`,`Rational functions, partial fractions, parametric and polar graphs.

${we}`),"Differential calculus":Z(`## Differential calculus`,`Calculus`,`Advanced differentiation — rules, implicit differentiation, and related rates.

${Ee}`),"Integral calculus":Z(`## Integral calculus`,`Calculus`,`Integration techniques and when to use them.

${De}`),"Differential equations":Z(`## Differential equations`,`Calculus`,`Equations involving derivatives — modelling and separable solutions.

${Oe}`),Kinematics:Z(`## Kinematics`,`Calculus / mechanics`,`Position, velocity and acceleration linked by calculus.

${ke}`),"Vectors in two and three dimensions":Z(`## Vectors in two and three dimensions`,`Space and measurement`,`Vector operations, dot product, projection, and cross product.

${Ae}`),"Lines and planes in 3D":Z(`## Lines and planes in 3D`,`Space and measurement`,`Lines and planes in 3D, normals, and distances.

${je}`),"Vector calculus":Z(`## Vector calculus`,`Space and measurement`,`Vector functions of time and parametric motion.

${Me}`),"Random variables and sampling":Z(`## Random variables and sampling`,`Data analysis, probability and statistics`,`Random variables, binomial and normal models, and sample means.

${Ne}`),"Confidence intervals":Z(`## Confidence intervals`,`Data analysis, probability and statistics`,`Estimate a population mean — plus exam strategy and key formulas.

${Pe}`)};function Fe(e){let t=String(e??``).trim();if(!t)return null;let n=v(t);if(Object.prototype.hasOwnProperty.call(Q,n))return Q[n];let r=Y(n),i=X[r]??X[Y(t)];if(i)return Q[i]??null;for(let e of u)if(Y(e)===r||Y(e)===Y(t))return Q[e];return null}function Ie(e){return/math|methods|specialist|further/i.test(e)}function Le(e){return e===`A`?`### Section A — Text response
...
- Conclusion: synthesis, not new evidence`:e===`B`?`### Section B — Creative writing
...
- Proofread for sentence control — clarity is marked`:`### Section C — Writing / argument analysis
...
- Compare two pieces only if the task asks for comparison`}function $(e){let t=e.subject?.name??e.subjectId;if(e.subjectId===`english`)return Le(e.englishSection??`A`);let n=(e.topic??`all`).trim();return!n||n===`all`?`### Your plan
- Pick a topic to focus your practice.
- Skim the overview (formulas / theory).
- Hit **Questions** to start.

**Subject:** ${t}`:e.subjectId===`methods`?Se(n)||`### ${n}
...
**Subject:** Mathematical Methods`:e.subjectId===`general-maths`?V(n)||`### ${n}
...
**Subject:** General Mathematics`:e.subjectId===`specialist-maths`?Fe(n)||`### ${n}
...
- Not linking evidence back to the question wording`}function Re(e){return Array.from(new Set(e.map(e=>e.trim()).filter(Boolean))).sort((e,t)=>e.localeCompare(t))}function ze(){let{subjectId:e}=i(),o=a(),{user:s}=te(),[c]=ee(),u=(0,j.useMemo)(()=>A.find(t=>String(t.id)===String(e)),[e]),[d,p]=(0,j.useState)(!0),[h,_]=(0,j.useState)([]),v=String(e)===`english`,y=String(c.get(`topic`)??`all`),b=String(c.get(`section`)??`A`).toUpperCase()||`A`,[N,P]=(0,j.useState)(y||`all`),[F,I]=(0,j.useState)(b===`B`||b===`C`?b:`A`);(0,j.useEffect)(()=>{if(!e)return;let i=!1;return(async()=>{try{if(p(!0),!s){_(l([],e));return}let a=await n(r.bootstrap);if(i)return;a.customQuestions&&localStorage.setItem(t.customQuestions,JSON.stringify(a.customQuestions)),_(l(g(a.customQuestions,e),e))}catch{let n=[];try{n=l(g(JSON.parse(localStorage.getItem(t.customQuestions)||`{}`),e),e)}catch{n=l([],e)}_(n)}finally{i||p(!1)}})(),()=>{i=!0}},[e,s]);let L=String(e)===`methods`,R=String(e)===`general-maths`,z=String(e)===`specialist-maths`,B=(0,j.useMemo)(()=>v?[]:L?f():R?m():z?re():[`all`,...Re(h.map(e=>e.topic??`General`))],[h,v,L,R,z]),V=(0,j.useMemo)(()=>e?v?$({subjectId:e,subject:u,topic:N,englishSection:F}):!N||N===`all`?null:$({subjectId:e,subject:u,topic:N,englishSection:F}):null,[e,u,N,F,v]);return(0,j.useEffect)(()=>{v||B.length&&!B.includes(N)&&P(`all`)},[B,N,v]),(0,M.jsx)(ne,{title:u?`${u.name} Practice`:`Practice`,subtitle:`Choose your focus, then start questions.`,edgeToEdgeHeader:!0,edgeToEdgeMain:!0,children:(0,M.jsxs)(`div`,{className:`mx-auto w-full max-w-6xl space-y-6`,children:[(0,M.jsxs)(O,{className:`overflow-hidden rounded-2xl border border-black/10 bg-white shadow-sm`,children:[(0,M.jsx)(`div`,{className:`h-1.5 bg-gradient-to-r from-brand via-brand-light to-amber`}),(0,M.jsxs)(E,{className:`flex flex-col gap-4 p-4 sm:p-5 lg:flex-row lg:items-center lg:justify-between`,children:[(0,M.jsxs)(`div`,{className:`min-w-0`,children:[(0,M.jsxs)(`div`,{className:`flex flex-wrap items-center gap-2`,children:[(0,M.jsx)(`p`,{className:`font-display text-xl font-semibold text-[#0b0f19]`,children:`Practice setup`}),(0,M.jsxs)(k,{variant:`secondary`,className:`gap-1`,children:[(0,M.jsx)(le,{className:`size-3.5`}),`Focus mode`]})]}),(0,M.jsx)(`p`,{className:`mt-1 text-sm text-muted-foreground`,children:`Pick a topic / section, then start questions.`})]}),(0,M.jsxs)(`div`,{className:`flex flex-col gap-2 sm:flex-row sm:items-end sm:gap-2 lg:gap-3 lg:justify-end`,children:[d?(0,M.jsxs)(`div`,{className:`flex items-center gap-2 rounded-xl border border-black/10 bg-slate-50 px-4 py-3 text-sm text-muted-foreground`,children:[(0,M.jsx)(oe,{className:`size-4 animate-spin`}),`Loading…`]}):v?(0,M.jsxs)(`div`,{className:`min-w-[260px] space-y-2`,children:[(0,M.jsx)(`p`,{className:`text-xs font-semibold uppercase tracking-wide text-muted-foreground`,children:`English section`}),(0,M.jsxs)(T,{value:F,onValueChange:e=>I(e??`A`),children:[(0,M.jsx)(S,{className:`h-11 border-black/10 bg-white text-[#0b0f19]`,children:(0,M.jsx)(x,{placeholder:`Choose section`})}),(0,M.jsxs)(C,{alignItemWithTrigger:!1,children:[(0,M.jsx)(w,{value:`A`,children:`Section A — Text response`}),(0,M.jsx)(w,{value:`B`,children:`Section B — Creative`}),(0,M.jsx)(w,{value:`C`,children:`Section C — Writing`})]})]})]}):(0,M.jsxs)(`div`,{className:`min-w-[260px] space-y-2`,children:[(0,M.jsx)(`p`,{className:`text-xs font-semibold uppercase tracking-wide text-muted-foreground`,children:`Topic`}),(0,M.jsxs)(T,{value:N,onValueChange:e=>P(e??`all`),children:[(0,M.jsx)(S,{className:`h-11 border-black/10 bg-white text-[#0b0f19]`,children:(0,M.jsx)(x,{placeholder:`Choose topic`})}),(0,M.jsx)(C,{alignItemWithTrigger:!1,className:`max-h-72`,children:B.map(e=>(0,M.jsx)(w,{value:e,children:e===`all`?`All topics`:e},e))})]})]}),(0,M.jsxs)(ie,{onClick:()=>{if(e){if(v){o(`/quiz/english?section=${encodeURIComponent(F)}`);return}o(`/quiz/${e}${N&&N!==`all`?`?topic=${encodeURIComponent(N)}`:``}`)}},className:`h-11 gap-2 bg-brand text-white hover:bg-brand-dark`,children:[(0,M.jsx)(ae,{className:`size-4`}),`Questions`,(0,M.jsx)(ce,{className:`size-4`})]})]})]})]}),(0,M.jsxs)(O,{className:`overflow-hidden rounded-2xl border border-black/10 bg-white shadow-sm`,children:[(0,M.jsx)(`div`,{className:`h-1.5 bg-gradient-to-r from-brand via-brand-light to-amber`,"aria-hidden":!0}),(0,M.jsxs)(se,{className:`space-y-3 px-6 pb-2 pt-6 sm:px-8`,children:[(0,M.jsx)(D,{className:`font-display text-2xl font-bold tracking-tight text-[#0b0f19] sm:text-3xl`,children:`Study overview`}),(0,M.jsx)(`p`,{className:`text-base font-medium text-muted-foreground sm:text-lg`,children:v?`Section summary for English practice.`:`Large-type reference for the topic you select.`})]}),(0,M.jsx)(E,{className:`px-4 pb-8 pt-2 sm:px-6 sm:pb-10`,children:V?(0,M.jsx)(ue,{markdown:V}):(0,M.jsx)(`div`,{className:`rounded-xl border border-dashed border-black/15 bg-slate-50 p-8 text-center`,children:(0,M.jsx)(`p`,{className:`text-sm font-medium text-muted-foreground`,children:`Select topic`})})})]})]})})}export{ze as default};