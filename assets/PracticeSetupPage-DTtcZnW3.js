import{$ as e,Q as t,W as n,Z as r,it as i,t as a,tt as o}from"./button-DIdSjIZY.js";import{h as ee,i as s,m as te,p as ne,r as re,v as ie}from"./api-CnQ5flgv.js";import{n as c}from"./AuthContext-BJiAxAvc.js";import{t as l}from"./AppShell-zmwh6YqI.js";import{n as u}from"./utils-CCdEIltr.js";import{Y as d,et as f}from"./index-3OvQIXGF.js";import{C as p,E as m,S as h,_ as ae,h as g,o as _,r as oe,v,w as se,x as y,y as b}from"./practiceQuestions-Cnyx-XQ-.js";import{n as x}from"./questionBankCache-EkzOEUI7.js";import{n as S,t as C}from"./card-6pGlZMSB.js";import{n as w,t as T}from"./subjects-gjS1wygj.js";import{t as E}from"./RichQuestionContent-DJ7Q0Iye.js";import{t as ce}from"./TopicPerformanceSelect-CsrWvqYb.js";var D=i(o(),1),O=n();function le({markdown:e,className:t}){return(0,O.jsx)(`div`,{className:u(`curriculum-overview relative overflow-hidden rounded-2xl`,`border border-black/10 border-l-4 border-l-brand-light/70 bg-[#f3f4f6]/50`,`px-5 py-7 sm:rounded-3xl sm:px-8 sm:py-9`,`text-[#0b0f19] antialiased`,`[&_.katex-error]:hidden`,`[&_a]:font-medium [&_a]:text-brand-deep [&_a]:underline [&_a]:decoration-brand/45 [&_a]:decoration-1 [&_a]:underline-offset-[3px] [&_a]:transition-colors hover:[&_a]:text-brand hover:[&_a]:decoration-brand`,t),children:(0,O.jsx)(E,{text:e,preferMarkdown:!0,overviewMode:!0})})}var k=`### Types of data
...
`,N=e=>String(e??``).trim().toLowerCase().replace(/\s+/g,` `),P={statistics:`Data analysis`,"data analysis, probability and statistics":`Data analysis`,finance:`Recursion and financial modelling`,sequences:`Recursion and financial modelling`,recursion:`Recursion and financial modelling`,matrices:`Matrices`,matrix:`Matrices`,networks:`Networks and decision mathematics`,graphs:`Networks and decision mathematics`,"discrete mathematics":`Matrices`,"algebra, number and structure":`Recursion and financial modelling`,"functions, relations and graphs":`Data analysis`,"space and measurement":`Data analysis`};function F(e,t,n){return`${e}

**Area:** ${t}

---

${n}`}var I={"Data analysis":F(`## Data analysis`,`Data analysis`,k),"Recursion and financial modelling":F(`## Recursion and financial modelling`,`Recursion and financial modelling`,`**Sequences** where each term depends on the previous term — used heavily in **finance**, loans, and investments.

${A}`),Matrices:F(`## Matrices`,`Matrices`,`Organising numbers in **arrays** to model transitions, networks, and systems.

${j}`),"Networks and decision mathematics":F(`## Networks and decision mathematics`,`Networks and decision mathematics`,`**Graphs**, **paths**, **optimisation**, and **scheduling**.

${M}`)};function L(e){let t=String(e??``).trim();if(!t)return null;let n=m(t);if(Object.prototype.hasOwnProperty.call(I,n))return I[n];let r=N(n),i=P[r]??P[N(t)];if(i)return I[i]??null;for(let e of p)if(N(e)===r||N(e)===N(t))return I[e];return null}var R=`A function takes an input $x$ and gives exactly one output $y$: $y = f(x)$.
...
`,U=`Calculus studies **change** (differentiation) and **accumulation** (integration).
...
`,de=`### Definite integrals and area
...
`,pe=`### Continuous random variables
...
`,ge=`### Confidence intervals for proportions
...
${n}`}var J={"Functions and transformations":q(`## Functions and transformations`,`Functions, relations and graphs`,R),"Polynomial, power and rational functions":q(`## Polynomial, power and rational functions`,`Functions, relations and graphs`,z),"Exponential and logarithmic functions":q(`## Exponential and logarithmic functions`,`Functions, relations and graphs`,B),"Circular functions":q(`## Circular functions`,`Functions, relations and graphs`,V),"Algebra and equations":q(`## Algebra and equations`,`Algebra`,H),"Differential calculus":q(`## Differential calculus`,`Calculus`,U),"Applications of differentiation":q(`## Applications of differentiation`,`Calculus`,W),"Integral calculus":q(`## Integral calculus`,`Calculus`,ue),"Applications of integration":q(`## Applications of integration`,`Calculus`,de),"Discrete random variables":q(`## Discrete random variables`,`Probability and statistics`,fe),"Continuous random variables":q(`## Continuous random variables`,`Probability and statistics`,pe),"The normal distribution":q(`## The normal distribution`,`Probability and statistics`,me),"Sampling and sample proportions":q(`## Sampling and sample proportions`,`Probability and statistics`,he),"Confidence intervals for proportions":q(`## Confidence intervals for proportions`,`Probability and statistics`,ge)};function _e(e){let t=String(e??``).trim();if(!t)return null;let n=h(t);if(Object.prototype.hasOwnProperty.call(J,n))return J[n];let r=G(n),i=K[r]??K[G(t)];if(i)return J[i]??null;for(let e of b)if(G(e)===r||G(e)===G(t))return J[e];return null}var ve=`### Logic and statements
...
`,De=`### Vector functions and motion
...
${ve}`),"Complex numbers and algebra":Z(`## Complex numbers and algebra`,`Algebra, number and structure`,`Complex arithmetic, polar form, De Moivre’s theorem, and roots.

${be}`),"Functions, relations and graphs":Z(`## Functions, relations and graphs`,`Functions, relations and graphs`,`Rational functions, partial fractions, parametric and polar graphs.

${ye}`),"Differential calculus":Z(`## Differential calculus`,`Calculus`,`Advanced differentiation — rules, implicit differentiation, and related rates.

${xe}`),"Integral calculus":Z(`## Integral calculus`,`Calculus`,`Integration techniques and when to use them.

${Se}`),"Differential equations":Z(`## Differential equations`,`Calculus`,`Equations involving derivatives — modelling and separable solutions.

${Ce}`),Kinematics:Z(`## Kinematics`,`Calculus / mechanics`,`Position, velocity and acceleration linked by calculus.

${we}`),"Vectors in two and three dimensions":Z(`## Vectors in two and three dimensions`,`Space and measurement`,`Vector operations, dot product, projection, and cross product.

${Te}`),"Lines and planes in 3D":Z(`## Lines and planes in 3D`,`Space and measurement`,`Lines and planes in 3D, normals, and distances.

${Ee}`),"Vector calculus":Z(`## Vector calculus`,`Space and measurement`,`Vector functions of time and parametric motion.

${De}`),"Random variables and sampling":Z(`## Random variables and sampling`,`Data analysis, probability and statistics`,`Random variables, binomial and normal models, and sample means.

${Oe}`),"Confidence intervals":Z(`## Confidence intervals`,`Data analysis, probability and statistics`,`Estimate a population mean — plus exam strategy and key formulas.

${ke}`)};function Ae(e){let t=String(e??``).trim();if(!t)return null;let n=v(t);if(Object.prototype.hasOwnProperty.call(Q,n))return Q[n];let r=Y(n),i=X[r]??X[Y(t)];if(i)return Q[i]??null;for(let e of g)if(Y(e)===r||Y(e)===Y(t))return Q[e];return null}function je(e){return/math|methods|specialist|further/i.test(e)}function Me(e){return e===`A`?`### Section A — Analytical response to a text
...
By describing the proposal as a “smarter investment”, the writer positions the audience to view the change as practical and responsible, strengthening support for their overall contention.`}function Ne(e){let t=e.subject?.name??e.subjectId;if(e.subjectId===`english`)return Me(e.englishSection??`A`);let n=(e.topic??`all`).trim();return!n||n===`all`?`### Your plan
- Pick a topic to focus your practice.
- Skim the overview (formulas / theory).
- Hit **Questions** to start.

**Subject:** ${t}`:e.subjectId===`methods`?_e(n)||`### ${n}
...
**Subject:** Mathematical Methods`:e.subjectId===`general-maths`||e.subjectId===`demo`?L(n)||`### ${n}
...
**Subject:** General Mathematics`:e.subjectId===`specialist-maths`?Ae(n)||`### ${n}
...
**Subject:** Specialist Mathematics`:je(t)?`### ${n}
...
- Not linking evidence back to the question wording`}function Pe(e){return Array.from(new Set(e.map(e=>e.trim()).filter(Boolean))).sort((e,t)=>e.localeCompare(t))}function $(){let{subjectId:n}=t(),i=r(),{user:o}=c(),u=ie(o),p=ee(o),[m]=e();(0,D.useEffect)(()=>{String(n)===`demo`&&!u&&i(`/dashboard`,{replace:!0})},[n,u,i]);let h=(0,D.useMemo)(()=>u?w({isAdmin:u}):T,[u]),g=(0,D.useMemo)(()=>h.find(e=>String(e.id)===String(n)),[h,n]),[v,b]=(0,D.useState)(!0),[E,k]=(0,D.useState)([]),A=String(n)===`english`;(0,D.useEffect)(()=>{A&&i(`/quiz/english`,{replace:!0})},[A,i]);let[j,M]=(0,D.useState)(String(m.get(`topic`)??`all`)||`all`);(0,D.useEffect)(()=>{if(!n)return;let e=!1,t=x(n);if(t.length>0)k(t),b(!1);else if(o)b(!0);else{k(_([],n)),b(!1);return}if(o)return(async()=>{try{let t=await s(ne.bootstrap,{timeoutMs:re});if(e)return;t.customQuestions&&localStorage.setItem(te.customQuestions,JSON.stringify(t.customQuestions)),k(_(oe(t.customQuestions,n),n))}catch{if(e)return;k(x(n))}finally{e||b(!1)}})(),()=>{e=!0}},[n,o]);let N=String(n)===`methods`,P=String(n)===`general-maths`||String(n)===`demo`,F=String(n)===`specialist-maths`,I=(0,D.useMemo)(()=>A?[]:N?y():P?se():F?ae():[`all`,...Pe(E.map(e=>e.topic??`General`))],[E,A,N,P,F]),L=(0,D.useMemo)(()=>I.filter(e=>e!==`all`),[I]),R=(0,D.useMemo)(()=>!n||A||!j||j===`all`?null:Ne({subjectId:n,subject:g,topic:j}),[n,g,j,A]);return(0,D.useEffect)(()=>{A||I.length&&!I.includes(j)&&M(`all`)},[I,j,A]),(0,O.jsx)(l,{title:g?`${g.name} Practice`:`Practice`,hideTitle:!0,edgeToEdgeHeader:!0,edgeToEdgeMain:!0,children:(0,O.jsxs)(`div`,{className:`mx-auto flex w-full min-h-[calc(100dvh-7rem)] max-w-7xl flex-col gap-6 px-1 py-4 sm:gap-8 sm:px-2 sm:py-6 lg:px-4`,children:[(0,O.jsxs)(`div`,{className:`text-center`,children:[(0,O.jsx)(`h1`,{className:`font-display text-[clamp(1.75rem,5vw,2.75rem)] font-bold tracking-tight text-[#0b0f19]`,children:g?.name??`Subject`}),(0,O.jsx)(`p`,{className:`mx-auto mt-2 max-w-xl text-sm text-muted-foreground sm:text-base`,children:`Pick a topic, then start questions — or browse past exams.`})]}),(0,O.jsxs)(`div`,{className:`flex flex-col gap-4 sm:gap-5`,children:[p&&!A?(0,O.jsx)(C,{className:`practice-card overflow-hidden`,children:(0,O.jsxs)(`button`,{type:`button`,onClick:()=>i(`/practice/${n}/exams`),className:`group w-full text-left`,children:[(0,O.jsxs)(`div`,{className:`practice-card-header !min-h-0 !justify-between !py-3.5 sm:!py-4`,children:[(0,O.jsx)(`p`,{className:`practice-card-header-title`,children:`Exams`}),(0,O.jsx)(`p`,{className:`practice-card-header-meta`,children:`Past papers by year`})]}),(0,O.jsxs)(`div`,{className:`flex items-center justify-between gap-4 bg-[#f3f4f6]/25 px-5 py-5 transition-colors group-hover:bg-[#f3f4f6]/45 sm:px-8 sm:py-6`,children:[(0,O.jsx)(`p`,{className:`text-sm text-muted-foreground sm:text-base`,children:`Open exam papers for this subject`}),(0,O.jsx)(f,{className:`size-5 shrink-0 text-muted-foreground transition-transform group-hover:translate-x-0.5 group-hover:text-[#0b0f19]`})]})]})}):null,(0,O.jsxs)(C,{className:`practice-card overflow-hidden`,children:[(0,O.jsxs)(`div`,{className:`practice-card-header !min-h-0 !justify-between !py-3.5 sm:!py-4`,children:[(0,O.jsx)(`p`,{className:`practice-card-header-title`,children:A?`Essay upload`:`Questions`}),(0,O.jsx)(`p`,{className:`practice-card-header-meta`,children:A?`Smart feedback`:`Instant marking`})]}),(0,O.jsxs)(S,{className:`flex flex-col gap-5 bg-[#f3f4f6]/25 px-5 py-6 sm:gap-6 sm:px-8 sm:py-7 lg:flex-row lg:items-center lg:justify-between`,children:[(0,O.jsx)(`p`,{className:`max-w-md text-sm leading-relaxed text-muted-foreground sm:text-base`,children:A?`Upload and get feedback on your writing.`:`Choose a topic, then work through questions at your own pace.`}),(0,O.jsxs)(`div`,{className:`flex w-full flex-col gap-3 sm:flex-row sm:items-center sm:justify-end lg:w-auto lg:shrink-0`,children:[v?(0,O.jsxs)(`div`,{className:`flex items-center gap-2 rounded-xl border border-black/8 bg-white px-4 py-3 text-sm text-muted-foreground`,children:[(0,O.jsx)(d,{className:`size-4 animate-spin`}),`Loading…`]}):A?(0,O.jsx)(`p`,{className:`text-sm text-muted-foreground`,children:`Redirecting…`}):(0,O.jsx)(ce,{subjectId:n,value:j,onValueChange:M,topics:L,includeAllOption:!0,placeholder:`Choose topic`,className:`w-full sm:w-[min(100%,18rem)]`}),(0,O.jsxs)(a,{variant:`accent`,onClick:()=>{if(n){if(A){i(`/quiz/english`);return}i(`/quiz/${n}${j&&j!==`all`?`?topic=${encodeURIComponent(j)}`:``}`)}},className:`h-12 w-full gap-2 rounded-xl px-6 text-base sm:w-auto sm:min-w-[10.5rem]`,children:[A?`Upload essay`:`Start`,(0,O.jsx)(f,{className:`size-4`})]})]})]})]})]}),A?null:(0,O.jsxs)(C,{className:`practice-card flex min-h-[min(24rem,42vh)] flex-1 flex-col`,children:[(0,O.jsx)(`div`,{className:`practice-card-header`,children:(0,O.jsx)(`p`,{className:`practice-card-header-title`,children:`Study overview`})}),(0,O.jsx)(S,{className:`flex flex-1 flex-col px-5 py-6 sm:px-8 sm:py-7`,children:R?(0,O.jsx)(le,{markdown:R}):(0,O.jsx)(`div`,{className:`flex flex-1 items-center justify-center rounded-2xl border border-dashed border-black/15 bg-[#0b0f19]/[0.03] p-10 text-center`,children:(0,O.jsx)(`p`,{className:`max-w-md text-sm font-medium text-muted-foreground sm:text-base`,children:`Choose a topic above to load overview notes for that area.`})})})]})]})})}export{$ as default};