...
${N}`)};function R(e){let t=String(e??``).trim();if(!t)return null;let n=w(t);if(Object.prototype.hasOwnProperty.call(L,n))return L[n];let r=P(n),i=F[r]??F[P(t)];if(i)return L[i]??null;for(let e of _)if(P(e)===r||P(e)===P(t))return L[e];return null}var z=`A function takes an input $x$ and gives exactly one output $y$: $y = f(x)$.
...
`,he=`### Continuous random variables
...
`,ve=`### Confidence intervals for proportions
...
${n}`}var J={"Functions and transformations":q(`## Functions and transformations`,`Functions, relations and graphs`,z),"Polynomial, power and rational functions":q(`## Polynomial, power and rational functions`,`Functions, relations and graphs`,B),"Exponential and logarithmic functions":q(`## Exponential and logarithmic functions`,`Functions, relations and graphs`,V),"Circular functions":q(`## Circular functions`,`Functions, relations and graphs`,H),"Algebra and equations":q(`## Algebra and equations`,`Algebra`,U),"Differential calculus":q(`## Differential calculus`,`Calculus`,de),"Applications of differentiation":q(`## Applications of differentiation`,`Calculus`,fe),"Integral calculus":q(`## Integral calculus`,`Calculus`,pe),"Applications of integration":q(`## Applications of integration`,`Calculus`,W),"Discrete random variables":q(`## Discrete random variables`,`Probability and statistics`,me),"Continuous random variables":q(`## Continuous random variables`,`Probability and statistics`,he),"The normal distribution":q(`## The normal distribution`,`Probability and statistics`,ge),"Sampling and sample proportions":q(`## Sampling and sample proportions`,`Probability and statistics`,_e),"Confidence intervals for proportions":q(`## Confidence intervals for proportions`,`Probability and statistics`,ve)};function ye(e){let t=String(e??``).trim();if(!t)return null;let n=g(t);if(Object.prototype.hasOwnProperty.call(J,n))return J[n];let r=G(n),i=K[r]??K[G(t)];if(i)return J[i]??null;for(let e of y)if(G(e)===r||G(e)===G(t))return J[e];return null}var be=`### Logic and statements
...
`,ke=`### Vector functions and motion
...
${be}`),"Complex numbers and algebra":Z(`## Complex numbers and algebra`,`Algebra, number and structure`,`Complex arithmetic, polar form, De Moivre’s theorem, and roots.

${Se}`),"Functions, relations and graphs":Z(`## Functions, relations and graphs`,`Functions, relations and graphs`,`Rational functions, partial fractions, parametric and polar graphs.

${xe}`),"Differential calculus":Z(`## Differential calculus`,`Calculus`,`Advanced differentiation — rules, implicit differentiation, and related rates.

${Ce}`),"Integral calculus":Z(`## Integral calculus`,`Calculus`,`Integration techniques and when to use them.

${we}`),"Differential equations":Z(`## Differential equations`,`Calculus`,`Equations involving derivatives — modelling and separable solutions.

${Te}`),Kinematics:Z(`## Kinematics`,`Calculus / mechanics`,`Position, velocity and acceleration linked by calculus.

${Ee}`),"Vectors in two and three dimensions":Z(`## Vectors in two and three dimensions`,`Space and measurement`,`Vector operations, dot product, projection, and cross product.

${De}`),"Lines and planes in 3D":Z(`## Lines and planes in 3D`,`Space and measurement`,`Lines and planes in 3D, normals, and distances.

${Oe}`),"Vector calculus":Z(`## Vector calculus`,`Space and measurement`,`Vector functions of time and parametric motion.

${ke}`),"Random variables and sampling":Z(`## Random variables and sampling`,`Data analysis, probability and statistics`,`Random variables, binomial and normal models, and sample means.

${Ae}`),"Confidence intervals":Z(`## Confidence intervals`,`Data analysis, probability and statistics`,`Estimate a population mean — plus exam strategy and key formulas.

${je}`)};function Me(e){let t=String(e??``).trim();if(!t)return null;let n=x(t);if(Object.prototype.hasOwnProperty.call(Q,n))return Q[n];let r=Y(n),i=X[r]??X[Y(t)];if(i)return Q[i]??null;for(let e of b)if(Y(e)===r||Y(e)===Y(t))return Q[e];return null}function Ne(e){return/math|methods|specialist|further/i.test(e)}function Pe(e){return e===`A`?`### Section A — Analytical response to a text
...
**Subject:** ${t}`:e.subjectId===`methods`?ye(n)||`### ${n}
...
**Subject:** General Mathematics`:e.subjectId===`specialist-maths`?Me(n)||`### ${n}
