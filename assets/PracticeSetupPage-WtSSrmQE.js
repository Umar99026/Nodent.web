import{$ as e,Q as t,W as n,Z as r,it as i,t as a,tt as o}from"./button-DIdSjIZY.js";import{_ as s,i as ee,m as te,p as c,r as ne}from"./api-CRbZMMvb.js";import{n as re}from"./AuthContext-Bp0EdHii.js";import{t as l}from"./AppShell-D-XubWrG.js";import{n as u}from"./utils-CCdEIltr.js";import{t as d}from"./book-open-CAKMiOH4.js";import{t as f}from"./file-text-AV82gzY7.js";import{J as p,Y as m,et as h}from"./index-UXXspmTx.js";import{C as g,E as _,S as v,_ as ie,h as y,o as b,r as ae,v as x,w as oe,x as S,y as C}from"./practiceQuestions-YScpkpLu.js";import{n as w}from"./questionBankCache-gS9spmyw.js";import{n as T,t as E}from"./card-6pGlZMSB.js";import{n as D,t as O}from"./subjects-gjS1wygj.js";import{t as k}from"./RichQuestionContent-CsuWla4j.js";import{n as se,t as ce}from"./premium-qrcTj7GB.js";import{t as le}from"./TopicPerformanceSelect-Ch1hZQBQ.js";var A=i(o(),1),j=n();function ue({markdown:e,className:t}){return(0,j.jsx)(`div`,{className:u(`curriculum-overview relative overflow-hidden rounded-2xl`,`border border-black/10 border-l-4 border-l-brand-light/70 bg-[#f3f4f6]/50`,`px-5 py-7 sm:rounded-3xl sm:px-8 sm:py-9`,`text-[#0b0f19] antialiased`,`[&_.katex-error]:hidden`,`[&_a]:font-medium [&_a]:text-brand-deep [&_a]:underline [&_a]:decoration-brand/45 [&_a]:decoration-1 [&_a]:underline-offset-[3px] [&_a]:transition-colors hover:[&_a]:text-brand hover:[&_a]:decoration-brand`,t),children:(0,j.jsx)(k,{text:e,preferMarkdown:!0,overviewMode:!0})})}var M=`### Types of data
...
${F}`)};function B(e){let t=String(e??``).trim();if(!t)return null;let n=_(t);if(Object.prototype.hasOwnProperty.call(z,n))return z[n];let r=I(n),i=L[r]??L[I(t)];if(i)return z[i]??null;for(let e of g)if(I(e)===r||I(e)===I(t))return z[e];return null}var V=`A function takes an input $x$ and gives exactly one output $y$: $y = f(x)$.
...
`,fe=`Calculus studies **change** (differentiation) and **accumulation** (integration).
...
`,he=`### Definite integrals and area
...
`,_e=`### Continuous random variables
...
${n}`}var Y={"Functions and transformations":J(`## Functions and transformations`,`Functions, relations and graphs`,V),"Polynomial, power and rational functions":J(`## Polynomial, power and rational functions`,`Functions, relations and graphs`,H),"Exponential and logarithmic functions":J(`## Exponential and logarithmic functions`,`Functions, relations and graphs`,U),"Circular functions":J(`## Circular functions`,`Functions, relations and graphs`,W),"Algebra and equations":J(`## Algebra and equations`,`Algebra`,de),"Differential calculus":J(`## Differential calculus`,`Calculus`,fe),"Applications of differentiation":J(`## Applications of differentiation`,`Calculus`,pe),"Integral calculus":J(`## Integral calculus`,`Calculus`,me),"Applications of integration":J(`## Applications of integration`,`Calculus`,he),"Discrete random variables":J(`## Discrete random variables`,`Probability and statistics`,ge),"Continuous random variables":J(`## Continuous random variables`,`Probability and statistics`,_e),"The normal distribution":J(`## The normal distribution`,`Probability and statistics`,G),"Sampling and sample proportions":J(`## Sampling and sample proportions`,`Probability and statistics`,ve),"Confidence intervals for proportions":J(`## Confidence intervals for proportions`,`Probability and statistics`,ye)};function be(e){let t=String(e??``).trim();if(!t)return null;let n=v(t);if(Object.prototype.hasOwnProperty.call(Y,n))return Y[n];let r=K(n),i=q[r]??q[K(t)];if(i)return Y[i]??null;for(let e of C)if(K(e)===r||K(e)===K(t))return Y[e];return null}var xe=`### Logic and statements
...
${xe}`),"Complex numbers and algebra":Q(`## Complex numbers and algebra`,`Algebra, number and structure`,`Complex arithmetic, polar form, De Moivre’s theorem, and roots.

${Ce}`),"Functions, relations and graphs":Q(`## Functions, relations and graphs`,`Functions, relations and graphs`,`Rational functions, partial fractions, parametric and polar graphs.

${Se}`),"Differential calculus":Q(`## Differential calculus`,`Calculus`,`Advanced differentiation — rules, implicit differentiation, and related rates.

${we}`),"Integral calculus":Q(`## Integral calculus`,`Calculus`,`Integration techniques and when to use them.

${Te}`),"Differential equations":Q(`## Differential equations`,`Calculus`,`Equations involving derivatives — modelling and separable solutions.

${Ee}`),Kinematics:Q(`## Kinematics`,`Calculus / mechanics`,`Position, velocity and acceleration linked by calculus.

${De}`),"Vectors in two and three dimensions":Q(`## Vectors in two and three dimensions`,`Space and measurement`,`Vector operations, dot product, projection, and cross product.

${Oe}`),"Lines and planes in 3D":Q(`## Lines and planes in 3D`,`Space and measurement`,`Lines and planes in 3D, normals, and distances.

${ke}`),"Vector calculus":Q(`## Vector calculus`,`Space and measurement`,`Vector functions of time and parametric motion.

${Ae}`),"Random variables and sampling":Q(`## Random variables and sampling`,`Data analysis, probability and statistics`,`Random variables, binomial and normal models, and sample means.

${je}`),"Confidence intervals":Q(`## Confidence intervals`,`Data analysis, probability and statistics`,`Estimate a population mean — plus exam strategy and key formulas.

${Me}`)};function Ne(e){let t=String(e??``).trim();if(!t)return null;let n=x(t);if(Object.prototype.hasOwnProperty.call($,n))return $[n];let r=X(n),i=Z[r]??Z[X(t)];if(i)return $[i]??null;for(let e of y)if(X(e)===r||X(e)===X(t))return $[e];return null}function Pe(e){return/math|methods|specialist|further/i.test(e)}function Fe(e){return e===`A`?`### Section A — Analytical response to a text
...
By describing the proposal as a “smarter investment”, the writer positions the audience to view the change as practical and responsible, strengthening support for their overall contention.`}function Ie(e){let t=e.subject?.name??e.subjectId;if(e.subjectId===`english`)return Fe(e.englishSection??`A`);let n=(e.topic??`all`).trim();return!n||n===`all`?`### Your plan
...
**Subject:** General Mathematics`:e.subjectId===`specialist-maths`?Ne(n)||`### ${n}
...
**Subject:** Specialist Mathematics`:Pe(t)?`### ${n}
...
- Not linking evidence back to the question wording`}function Le(e){return Array.from(new Set(e.map(e=>e.trim()).filter(Boolean))).sort((e,t)=>e.localeCompare(t))}function Re(){let{subjectId:n}=t(),i=r(),{user:o}=re(),u=s(o),g=se(o),[_,v]=e();(0,A.useEffect)(()=>{String(n)===`demo`&&!u&&i(`/dashboard`,{replace:!0})},[n,u,i]);let y=(0,A.useMemo)(()=>u?D({isAdmin:u}):O,[u]),x=(0,A.useMemo)(()=>y.find(e=>String(e.id)===String(n)),[y,n]),[C,k]=(0,A.useState)(!0),[M,N]=(0,A.useState)([]),P=String(n)===`english`;(0,A.useEffect)(()=>{P&&i(`/quiz/english`,{replace:!0})},[P,i]);let[F,I]=(0,A.useState)(String(_.get(`topic`)??`all`)||`all`);(0,A.useEffect)(()=>{let e=String(_.get(`topic`)??`all`)||`all`;I(t=>t===e?t:e)},[_]);let L=e=>{I(e),v(t=>{let n=new URLSearchParams(t);return!e||e===`all`?n.delete(`topic`):n.set(`topic`,e),n},{replace:!0})};(0,A.useEffect)(()=>{if(!n)return;let e=!1,t=w(n);if(t.length>0)N(t),k(!1);else if(o)k(!0);else{N(b([],n)),k(!1);return}if(o)return(async()=>{try{let t=await ee(c.bootstrap,{timeoutMs:ne});if(e)return;t.customQuestions&&localStorage.setItem(te.customQuestions,JSON.stringify(t.customQuestions)),N(b(ae(t.customQuestions,n),n))}catch{if(e)return;N(w(n))}finally{e||k(!1)}})(),()=>{e=!0}},[n,o]);let R=String(n)===`methods`,z=String(n)===`general-maths`||String(n)===`demo`,B=String(n)===`specialist-maths`,V=(0,A.useMemo)(()=>P?[]:R?S():z?oe():B?ie():[`all`,...Le(M.map(e=>e.topic??`General`))],[M,P,R,z,B]),H=(0,A.useMemo)(()=>V.filter(e=>e!==`all`),[V]),U=(0,A.useMemo)(()=>!n||P||!F||F===`all`?null:Ie({subjectId:n,subject:x,topic:F}),[n,x,F,P]);(0,A.useEffect)(()=>{P||V.length&&!V.includes(F)&&I(`all`)},[V,F,P]);let W=()=>{if(n){if(P){i(`/quiz/english`);return}i(`/quiz/${n}${F&&F!==`all`?`?topic=${encodeURIComponent(F)}`:``}`)}};return(0,j.jsx)(l,{title:`Practice`,edgeToEdgeHeader:!0,edgeToEdgeMain:!0,children:(0,j.jsx)(`div`,{className:`mx-auto w-full max-w-6xl space-y-5 sm:space-y-6`,children:(0,j.jsx)(E,{className:`practice-card`,children:(0,j.jsx)(T,{className:`bg-[#f3f4f6]/30 px-4 py-8 sm:px-7 sm:py-10`,children:(0,j.jsxs)(`div`,{className:`mx-auto flex min-h-[min(32rem,70vh)] w-full max-w-4xl flex-col`,children:[(0,j.jsx)(`div`,{className:`text-center`,children:(0,j.jsx)(`p`,{className:`font-display text-2xl font-semibold tracking-tight text-[#0b0f19] sm:text-3xl`,children:x?.name??`Practice`})}),(0,j.jsx)(`div`,{className:`mt-7 flex flex-1 flex-col sm:mt-9`,children:C?(0,j.jsxs)(`div`,{className:`flex items-center justify-center gap-2 rounded-2xl border border-black/8 bg-white px-5 py-4 text-sm text-muted-foreground`,children:[(0,j.jsx)(m,{className:`size-4 animate-spin`}),`Loading…`]}):P?(0,j.jsx)(`p`,{className:`text-center text-sm text-muted-foreground`,children:`Redirecting…`}):(0,j.jsxs)(j.Fragment,{children:[(0,j.jsxs)(`div`,{className:`mx-auto flex w-full max-w-3xl flex-col items-center gap-4`,children:[(0,j.jsxs)(`div`,{className:`flex w-full flex-col items-stretch gap-3 sm:flex-row sm:items-start sm:justify-center`,children:[(0,j.jsxs)(`div`,{className:`w-full sm:w-[18rem]`,children:[(0,j.jsx)(`p`,{className:`mb-2 text-center text-[0.6875rem] font-semibold uppercase tracking-[0.12em] text-muted-foreground`,children:`Topic`}),(0,j.jsx)(le,{subjectId:n,value:F,onValueChange:L,topics:H,includeAllOption:!0,placeholder:`Choose topic`,className:`w-full sm:w-[18rem]`})]}),(0,j.jsxs)(`div`,{className:`w-full sm:w-[18rem]`,children:[(0,j.jsx)(`p`,{className:`mb-2 text-center text-[0.6875rem] font-semibold uppercase tracking-[0.12em] text-transparent`,"aria-hidden":!0,children:`Topic`}),(0,j.jsxs)(a,{variant:`accent`,onClick:W,className:`h-12 w-full gap-2 rounded-2xl text-base sm:w-[18rem]`,children:[(0,j.jsx)(d,{className:`size-4`}),`Questions`,(0,j.jsx)(h,{className:`size-4`})]})]})]}),(0,j.jsxs)(a,{type:`button`,variant:`outline`,onClick:()=>{if(!g){i(ce);return}i(`/practice/${n}/exams`)},className:`h-12 w-full max-w-xs gap-2 rounded-2xl text-base`,"aria-label":g?`Open past exams`:`Past exams — Premium required`,children:[g?(0,j.jsx)(f,{className:`size-4`}):(0,j.jsx)(p,{className:`size-4 text-muted-foreground`}),`Exams`,g?(0,j.jsx)(h,{className:`size-4`}):null]})]}),(0,j.jsx)(`div`,{className:`mt-10 flex flex-1 flex-col justify-center`,children:U?(0,j.jsx)(ue,{markdown:U}):(0,j.jsx)(`p`,{className:`text-center text-sm text-muted-foreground sm:text-base`,children:`Choose what to revise`})})]})})]})})})})})}export{Re as default};