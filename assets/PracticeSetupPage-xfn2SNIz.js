import{J as e,K as t,Q as n,Y as r,q as i,t as a,z as o}from"./button-PA9U5EVN.js";import{_ as ee,b as s,g as te,i as ne,r as re}from"./api-BNGNlnQn.js";import{n as c}from"./AuthContext-viXzA89-.js";import{t as l}from"./AppShell-WHp4kuw2.js";import{n as u}from"./utils-DKR2NgSu.js";import{t as d}from"./file-text--ZFZMLfg.js";import{t as f}from"./loader-circle-1WEqZ3Dm.js";import{c as p,m as ie,p as ae}from"./index-CVTSvApI.js";import{S as m,_ as oe,b as h,d as g,h as _,m as v,p as se,v as y,y as b}from"./practiceQuestions-DonOcrmJ.js";import{n as x}from"./questionBankCache-CQl64fOQ.js";import{n as ce,t as le}from"./card-vxqQZXtH.js";import{n as ue,t as de}from"./subjects-NpZMKgtM.js";import{t as S}from"./RichQuestionContent-B4upYyQN.js";import{a as fe,n as C,r as w}from"./premium-Cj_AOwOK.js";import{r as pe}from"./premiumUsage-CKcXvZKT.js";import{i as T,n as me,r as he,t as ge}from"./tabs-C7YGZPLG.js";import{t as _e}from"./TopicPerformanceSelect-CVOd3964.js";var E=n(r(),1),D=o();function ve({markdown:e,className:t}){return(0,D.jsx)(`div`,{className:u(`curriculum-overview relative overflow-hidden rounded-2xl`,`border border-black/10 border-l-4 border-l-brand-light/70 bg-[#f3f4f6]/50`,`px-5 py-7 sm:rounded-3xl sm:px-8 sm:py-9`,`text-[#0b0f19] antialiased`,`[&_.katex-error]:hidden`,`[&_a]:font-medium [&_a]:text-brand-deep [&_a]:underline [&_a]:decoration-brand/45 [&_a]:decoration-1 [&_a]:underline-offset-[3px] [&_a]:transition-colors hover:[&_a]:text-brand hover:[&_a]:decoration-brand`,t),children:(0,D.jsx)(S,{text:e,preferMarkdown:!0,overviewMode:!0})})}var O=`### Types of data
...
`,M=e=>String(e??``).trim().toLowerCase().replace(/\s+/g,` `),N={statistics:`Data analysis`,"data analysis, probability and statistics":`Data analysis`,finance:`Recursion and financial modelling`,sequences:`Recursion and financial modelling`,recursion:`Recursion and financial modelling`,matrices:`Matrices`,matrix:`Matrices`,networks:`Networks and decision mathematics`,graphs:`Networks and decision mathematics`,"discrete mathematics":`Matrices`,"algebra, number and structure":`Recursion and financial modelling`,"functions, relations and graphs":`Data analysis`,"space and measurement":`Data analysis`};function P(e,t,n){return`${e}

**Area:** ${t}

---

${n}`}var F={"Data analysis":P(`## Data analysis`,`Data analysis`,O),"Recursion and financial modelling":P(`## Recursion and financial modelling`,`Recursion and financial modelling`,`**Sequences** where each term depends on the previous term — used heavily in **finance**, loans, and investments.

${k}`),Matrices:P(`## Matrices`,`Matrices`,`Organising numbers in **arrays** to model transitions, networks, and systems.

${A}`),"Networks and decision mathematics":P(`## Networks and decision mathematics`,`Networks and decision mathematics`,`**Graphs**, **paths**, **optimisation**, and **scheduling**.

${j}`)};function I(e){let t=String(e??``).trim();if(!t)return null;let n=m(t);if(Object.prototype.hasOwnProperty.call(F,n))return F[n];let r=M(n),i=N[r]??N[M(t)];if(i)return F[i]??null;for(let e of b)if(M(e)===r||M(e)===M(t))return F[e];return null}var L=`A function takes an input $x$ and gives exactly one output $y$: $y = f(x)$.
...
`,H=`Calculus studies **change** (differentiation) and **accumulation** (integration).
...
`,ye=`### Definite integrals and area
...
${n}`}var Y={"Functions and transformations":J(`## Functions and transformations`,`Functions, relations and graphs`,L),"Polynomial, power and rational functions":J(`## Polynomial, power and rational functions`,`Functions, relations and graphs`,R),"Exponential and logarithmic functions":J(`## Exponential and logarithmic functions`,`Functions, relations and graphs`,z),"Circular functions":J(`## Circular functions`,`Functions, relations and graphs`,B),"Algebra and equations":J(`## Algebra and equations`,`Algebra`,V),"Differential calculus":J(`## Differential calculus`,`Calculus`,H),"Applications of differentiation":J(`## Applications of differentiation`,`Calculus`,U),"Integral calculus":J(`## Integral calculus`,`Calculus`,W),"Applications of integration":J(`## Applications of integration`,`Calculus`,ye),"Discrete random variables":J(`## Discrete random variables`,`Probability and statistics`,be),"Continuous random variables":J(`## Continuous random variables`,`Probability and statistics`,xe),"The normal distribution":J(`## The normal distribution`,`Probability and statistics`,Se),"Sampling and sample proportions":J(`## Sampling and sample proportions`,`Probability and statistics`,Ce),"Confidence intervals for proportions":J(`## Confidence intervals for proportions`,`Probability and statistics`,G)};function we(e){let t=String(e??``).trim();if(!t)return null;let n=y(t);if(Object.prototype.hasOwnProperty.call(Y,n))return Y[n];let r=K(n),i=q[r]??q[K(t)];if(i)return Y[i]??null;for(let e of _)if(K(e)===r||K(e)===K(t))return Y[e];return null}var Te=`### Logic and statements
...
**Subject:** Mathematical Methods`:e.subjectId===`general-maths`||e.subjectId===`demo`?I(n)||`### ${n}
...
- Not linking evidence back to the question wording`}function Ve(e){return Array.from(new Set(e.map(e=>e.trim()).filter(Boolean))).sort((e,t)=>e.localeCompare(t))}function He(){let{subjectId:n}=i(),r=t(),{user:o}=c(),u=s(o),m=w(o),g=fe(o),[_,v]=e();(0,E.useEffect)(()=>{String(n)===`demo`&&!u&&r(`/dashboard`,{replace:!0})},[n,u,r]);let y=(0,E.useMemo)(()=>u?ue({isAdmin:u}):de,[u]),b=(0,E.useMemo)(()=>y.find(e=>String(e.id)===String(n)),[y,n]),[S,O]=(0,E.useState)(!0),[k,A]=(0,E.useState)([]),j=String(n)===`english`;(0,E.useEffect)(()=>{j&&r(`/quiz/english`,{replace:!0})},[j,r]);let[M,N]=(0,E.useState)(String(_.get(`topic`)??`all`)||`all`),P=String(_.get(`kind`)??`mixed`).trim()||`mixed`,[F,I]=(0,E.useState)(()=>{let e=[`mixed`,`mcq`,`sa`,`la`,`exams`].includes(P)?P:`mixed`;return e===`la`&&!g||e===`exams`&&!m?`mixed`:e});(0,E.useEffect)(()=>{let e=String(_.get(`topic`)??`all`)||`all`;N(t=>t===e?t:e)},[_]),(0,E.useEffect)(()=>{let e=String(_.get(`kind`)??`mixed`).trim().toLowerCase();if(e&&e!==F&&(e===`mixed`||e===`mcq`||e===`sa`||e===`la`||e===`exams`)){if(e===`la`&&!g){I(`mixed`);return}I(e)}},[_,F,g]),(0,E.useEffect)(()=>{g||F===`la`&&(I(`mixed`),v(e=>{let t=new URLSearchParams(e);return t.delete(`kind`),t},{replace:!0}))},[g,F,v]);let L=e=>{N(e),v(t=>{let n=new URLSearchParams(t);return!e||e===`all`?n.delete(`topic`):n.set(`topic`,e),n},{replace:!0})},R=e=>{if(e===`la`&&!g){r(C);return}if(e===`exams`&&!m){r(C);return}I(e),v(t=>{let n=new URLSearchParams(t);return!e||e===`mixed`?n.delete(`kind`):n.set(`kind`,e),n},{replace:!0})};(0,E.useEffect)(()=>{if(!n)return;let e=!1,t=x(n);if(t.length>0)A(t),O(!1);else if(o)O(!0);else{A(x(n)),O(!1);return}if(o)return(async()=>{try{let t=await ne(te.bootstrap,{timeoutMs:re});if(e)return;t.customQuestions&&localStorage.setItem(ee.customQuestions,JSON.stringify(t.customQuestions)),A(x(n))}catch{if(e)return;A(x(n))}finally{e||O(!1)}})(),()=>{e=!0}},[n,o]);let z=String(n)===`methods`,B=String(n)===`general-maths`||String(n)===`demo`,V=String(n)===`specialist-maths`,H=(0,E.useMemo)(()=>j?[]:z?oe():B?h():V?se():[`all`,...Ve(k.map(e=>e.topic??`General`))],[k,j,z,B,V]),U=(0,E.useMemo)(()=>H.filter(e=>e!==`all`),[H]),W=(0,E.useMemo)(()=>!n||j||!M||M===`all`?null:Be({subjectId:n,subject:b,topic:M}),[n,b,M,j]);return(0,E.useEffect)(()=>{j||H.length&&!H.includes(M)&&N(`all`)},[H,M,j]),(0,D.jsx)(l,{title:`Practice`,edgeToEdgeHeader:!0,edgeToEdgeMain:!0,children:(0,D.jsx)(`div`,{className:`mx-auto w-full max-w-6xl space-y-5 sm:space-y-6`,children:(0,D.jsx)(le,{className:`practice-card`,children:(0,D.jsx)(ce,{className:`bg-[#f3f4f6]/30 px-4 py-8 sm:px-7 sm:py-10`,children:(0,D.jsxs)(`div`,{className:`mx-auto flex min-h-[min(32rem,70vh)] w-full max-w-4xl flex-col`,children:[(0,D.jsx)(`div`,{className:`text-center`,children:(0,D.jsx)(`p`,{className:`font-display text-2xl font-semibold tracking-tight text-[#0b0f19] sm:text-3xl`,children:b?.name??`Practice`})}),(0,D.jsx)(`div`,{className:`mt-7 flex flex-1 flex-col sm:mt-9`,children:S?(0,D.jsxs)(`div`,{className:`flex items-center justify-center gap-2 rounded-2xl border border-black/8 bg-white px-5 py-4 text-sm text-muted-foreground`,children:[(0,D.jsx)(f,{className:`size-4 animate-spin`}),`Loading…`]}):j?(0,D.jsx)(`p`,{className:`text-center text-sm text-muted-foreground`,children:`Redirecting…`}):(0,D.jsxs)(D.Fragment,{children:[(0,D.jsxs)(`div`,{className:`mx-auto flex w-full max-w-3xl flex-col items-center gap-4`,children:[(0,D.jsxs)(`div`,{className:`w-full`,children:[(0,D.jsx)(`p`,{className:`mb-2 text-center text-[0.6875rem] font-semibold uppercase tracking-[0.12em] text-muted-foreground`,children:`Practice mode`}),(0,D.jsxs)(ge,{value:F,onValueChange:e=>R(e),children:[(0,D.jsxs)(he,{className:`mx-auto w-full max-w-3xl justify-between`,children:[(0,D.jsx)(T,{value:`mixed`,children:`Mixed`}),(0,D.jsx)(T,{value:`mcq`,children:`MCQ`}),(0,D.jsx)(T,{value:`sa`,children:`SA`}),(0,D.jsx)(T,{value:`la`,"aria-disabled":!g,children:g?`LA`:`LA (Premium)`}),(0,D.jsx)(T,{value:`exams`,"aria-disabled":!m,children:m?`Exams`:`Exams (Premium)`})]}),(0,D.jsx)(me,{value:F,className:`mt-3`,children:(0,D.jsx)(`div`,{className:`rounded-2xl border border-black/8 bg-white px-4 py-3 text-sm text-muted-foreground`,children:F===`exams`?(0,D.jsxs)(`div`,{className:`flex items-start gap-2`,children:[(0,D.jsx)(`span`,{className:`mt-0.5`,children:m?(0,D.jsx)(d,{className:`size-4 text-foreground`}):(0,D.jsx)(p,{className:`size-4`})}),(0,D.jsxs)(`div`,{className:`min-w-0`,children:[(0,D.jsx)(`p`,{className:`font-medium text-foreground`,children:`Past practice exams`}),(0,D.jsx)(`p`,{className:`mt-0.5`,children:m?`Browse past papers by topic and attempt them like the real exam.`:`Premium only. Free accounts can practice MCQ and short answers.`})]})]}):F===`mcq`?(0,D.jsx)(`p`,{children:`Multiple choice only. Fast reps + quick confidence building.`}):F===`sa`?(0,D.jsx)(`p`,{children:`Typed or drawn answers share 3 detailed AI responses each day. After that, typed answers continue with unlimited instant matching.`}):F===`la`?(0,D.jsxs)(`div`,{className:`flex items-start gap-2`,children:[(0,D.jsx)(p,{className:`mt-0.5 size-4 shrink-0`}),(0,D.jsxs)(`div`,{children:[(0,D.jsx)(`p`,{className:`font-medium text-foreground`,children:`Long-answer practice`}),(0,D.jsx)(`p`,{className:`mt-0.5`,children:g?`Full working, mark breakdown, and harder reasoning.`:`Premium only. Free accounts use MCQ and short-answer practice.`})]})]}):(0,D.jsx)(`p`,{children:g?`Mixed practice. We’ll rotate question styles while staying on your chosen topic.`:`Mixed MCQ and short answers (no long answers on Free).`})})})]}),(0,D.jsxs)(`div`,{className:`mt-3 rounded-2xl border border-black/8 bg-white px-4 py-3 text-left text-sm`,children:[(0,D.jsx)(`p`,{className:`font-semibold text-[#0b0f19]`,children:`Your plan limits`}),g?(0,D.jsx)(`p`,{className:`mt-1 text-muted-foreground`,children:`Premium: Unlimited topic practice, unlimited AI marking, Ask AI, and full practice exams.`}):(0,D.jsxs)(`p`,{className:`mt-1 text-muted-foreground`,children:[`Free: `,pe(),` · exams not included.`,(0,D.jsx)(`button`,{type:`button`,className:`ml-1 font-semibold text-brand-dark hover:underline`,onClick:()=>r(C),children:`View Premium`})]})]})]}),(0,D.jsxs)(`div`,{className:`flex w-full flex-col items-stretch gap-3 sm:flex-row sm:items-start sm:justify-center`,children:[(0,D.jsxs)(`div`,{className:`w-full sm:w-[18rem]`,children:[(0,D.jsx)(`p`,{className:`mb-2 text-center text-[0.6875rem] font-semibold uppercase tracking-[0.12em] text-muted-foreground`,children:`Topic`}),(0,D.jsx)(_e,{subjectId:n,value:M,onValueChange:L,topics:U,includeAllOption:!0,placeholder:`Choose topic`,className:`w-full sm:w-[18rem]`})]}),(0,D.jsxs)(`div`,{className:`w-full sm:w-[18rem]`,children:[(0,D.jsx)(`p`,{className:`mb-2 text-center text-[0.6875rem] font-semibold uppercase tracking-[0.12em] text-transparent`,"aria-hidden":!0,children:`Topic`}),(0,D.jsxs)(a,{variant:`accent`,onClick:()=>{if(!n)return;if(j){r(`/quiz/english`);return}if(F===`la`&&!g){r(C);return}if(F===`exams`){if(!m){r(C);return}r(`/practice/${n}/exams`);return}let e=new URLSearchParams;M&&M!==`all`&&e.set(`topic`,M),F&&F!==`mixed`&&e.set(`kind`,F);let t=e.toString()?`?${e.toString()}`:``;r(`/quiz/${n}${t}`)},className:`h-12 w-full gap-2 rounded-2xl text-base sm:w-[18rem]`,children:[F===`exams`?m?(0,D.jsx)(d,{className:`size-4`}):(0,D.jsx)(p,{className:`size-4`}):(0,D.jsx)(ae,{className:`size-4`}),F===`exams`?m?`Open exams`:`Premium exams`:`Start practice`,(0,D.jsx)(ie,{className:`size-4`})]})]})]})]}),(0,D.jsx)(`div`,{className:`mt-10 flex flex-1 flex-col justify-center`,children:W?(0,D.jsx)(ve,{markdown:W}):(0,D.jsx)(`p`,{className:`text-center text-sm text-muted-foreground sm:text-base`,children:`Choose what to revise`})})]})})]})})})})})}export{He as default};