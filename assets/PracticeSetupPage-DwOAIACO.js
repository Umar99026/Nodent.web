import{Gt as e,Ht as t,Qt as n,Xt as r,Zt as i,an as a,fn as o,ln as s,n as ee,on as te,sn as ne,u as c}from"./NodentWordmark-CO5y-ebc.js";import{R as re}from"./DirectionContext-CayTAwc5.js";import{t as ie}from"./AppShell-DLHiz_9i.js";import{a as l,i as u,n as d,r as f,t as p}from"./select-D0FPzCs6.js";import{t as ae}from"./loader-circle-BbAB0nwi.js";import{c as oe,s as m}from"./index-BsrocvPq.js";import{B as h,F as g,H as _,I as v,L as y,R as b,U as x,V as S,o as C,r as w,z as se}from"./practiceQuestions-CZ2Qgslt.js";import{n as T,t as E}from"./card-BFifHcBB.js";import{n as ce,t as le}from"./subjects-Y2QW-OeV.js";import{r as D}from"./QuestionStimulus-6dZWSqwf.js";var O=o(s(),1),k=t();function ue({markdown:e,className:t}){return(0,k.jsx)(`div`,{className:c(`curriculum-overview relative overflow-hidden rounded-2xl`,`border border-black/10 border-l-4 border-l-brand-light/70 bg-[#f3f4f6]/50`,`px-5 py-7 sm:rounded-3xl sm:px-8 sm:py-9`,`text-[#0b0f19] antialiased`,`[&_.katex-error]:hidden`,`[&_a]:font-medium [&_a]:text-brand-deep [&_a]:underline [&_a]:decoration-brand/45 [&_a]:decoration-1 [&_a]:underline-offset-[3px] [&_a]:transition-colors hover:[&_a]:text-brand hover:[&_a]:decoration-brand`,t),children:(0,k.jsx)(D,{text:e,preferMarkdown:!0,overviewMode:!0})})}var A=`### Types of data
...
`,P=e=>String(e??``).trim().toLowerCase().replace(/\s+/g,` `),F={statistics:`Data analysis`,"data analysis, probability and statistics":`Data analysis`,finance:`Recursion and financial modelling`,sequences:`Recursion and financial modelling`,recursion:`Recursion and financial modelling`,matrices:`Matrices`,matrix:`Matrices`,networks:`Networks and decision mathematics`,graphs:`Networks and decision mathematics`,"discrete mathematics":`Matrices`,"algebra, number and structure":`Recursion and financial modelling`,"functions, relations and graphs":`Data analysis`,"space and measurement":`Data analysis`};function I(e,t,n){return`${e}

**Area:** ${t}

---

${n}`}var L={"Data analysis":I(`## Data analysis`,`Data analysis`,A),"Recursion and financial modelling":I(`## Recursion and financial modelling`,`Recursion and financial modelling`,`**Sequences** where each term depends on the previous term — used heavily in **finance**, loans, and investments.

${j}`),Matrices:I(`## Matrices`,`Matrices`,`Organising numbers in **arrays** to model transitions, networks, and systems.

${M}`),"Networks and decision mathematics":I(`## Networks and decision mathematics`,`Networks and decision mathematics`,`**Graphs**, **paths**, **optimisation**, and **scheduling**.

${N}`)};function R(e){let t=String(e??``).trim();if(!t)return null;let n=x(t);if(Object.prototype.hasOwnProperty.call(L,n))return L[n];let r=P(n),i=F[r]??F[P(t)];if(i)return L[i]??null;for(let e of S)if(P(e)===r||P(e)===P(t))return L[e];return null}var z=`A function takes an input $x$ and gives exactly one output $y$: $y = f(x)$.
...
`,de=`Calculus studies **change** (differentiation) and **accumulation** (integration).
...
`,me=`### Definite integrals and area
...
`,ge=`### Continuous random variables
...
`,ye=`### Confidence intervals for proportions
...
${n}`}var q={"Functions and transformations":K(`## Functions and transformations`,`Functions, relations and graphs`,z),"Polynomial, power and rational functions":K(`## Polynomial, power and rational functions`,`Functions, relations and graphs`,B),"Exponential and logarithmic functions":K(`## Exponential and logarithmic functions`,`Functions, relations and graphs`,V),"Circular functions":K(`## Circular functions`,`Functions, relations and graphs`,H),"Algebra and equations":K(`## Algebra and equations`,`Algebra`,U),"Differential calculus":K(`## Differential calculus`,`Calculus`,de),"Applications of differentiation":K(`## Applications of differentiation`,`Calculus`,fe),"Integral calculus":K(`## Integral calculus`,`Calculus`,pe),"Applications of integration":K(`## Applications of integration`,`Calculus`,me),"Discrete random variables":K(`## Discrete random variables`,`Probability and statistics`,he),"Continuous random variables":K(`## Continuous random variables`,`Probability and statistics`,ge),"The normal distribution":K(`## The normal distribution`,`Probability and statistics`,_e),"Sampling and sample proportions":K(`## Sampling and sample proportions`,`Probability and statistics`,ve),"Confidence intervals for proportions":K(`## Confidence intervals for proportions`,`Probability and statistics`,ye)};function be(e){let t=String(e??``).trim();if(!t)return null;let n=h(t);if(Object.prototype.hasOwnProperty.call(q,n))return q[n];let r=W(n),i=G[r]??G[W(t)];if(i)return q[i]??null;for(let e of b)if(W(e)===r||W(e)===W(t))return q[e];return null}var xe=`### Logic and statements
...
`,Ae=`### Vector functions and motion
...
${xe}`),"Complex numbers and algebra":X(`## Complex numbers and algebra`,`Algebra, number and structure`,`Complex arithmetic, polar form, De Moivre’s theorem, and roots.

${Ce}`),"Functions, relations and graphs":X(`## Functions, relations and graphs`,`Functions, relations and graphs`,`Rational functions, partial fractions, parametric and polar graphs.

${Se}`),"Differential calculus":X(`## Differential calculus`,`Calculus`,`Advanced differentiation — rules, implicit differentiation, and related rates.

${we}`),"Integral calculus":X(`## Integral calculus`,`Calculus`,`Integration techniques and when to use them.

${Te}`),"Differential equations":X(`## Differential equations`,`Calculus`,`Equations involving derivatives — modelling and separable solutions.

${Ee}`),Kinematics:X(`## Kinematics`,`Calculus / mechanics`,`Position, velocity and acceleration linked by calculus.

${De}`),"Vectors in two and three dimensions":X(`## Vectors in two and three dimensions`,`Space and measurement`,`Vector operations, dot product, projection, and cross product.

${Oe}`),"Lines and planes in 3D":X(`## Lines and planes in 3D`,`Space and measurement`,`Lines and planes in 3D, normals, and distances.

${ke}`),"Vector calculus":X(`## Vector calculus`,`Space and measurement`,`Vector functions of time and parametric motion.

${Ae}`),"Random variables and sampling":X(`## Random variables and sampling`,`Data analysis, probability and statistics`,`Random variables, binomial and normal models, and sample means.

${je}`),"Confidence intervals":X(`## Confidence intervals`,`Data analysis, probability and statistics`,`Estimate a population mean — plus exam strategy and key formulas.

${Me}`)};function Q(e){let t=String(e??``).trim();if(!t)return null;let n=y(t);if(Object.prototype.hasOwnProperty.call(Z,n))return Z[n];let r=J(n),i=Y[r]??Y[J(t)];if(i)return Z[i]??null;for(let e of g)if(J(e)===r||J(e)===J(t))return Z[e];return null}function Ne(e){return/math|methods|specialist|further/i.test(e)}function Pe(e){return e===`A`?`### Section A — Analytical response to a text
...
By describing the proposal as a “smarter investment”, the writer positions the audience to view the change as practical and responsible, strengthening support for their overall contention.`}function $(e){let t=e.subject?.name??e.subjectId;if(e.subjectId===`english`)return Pe(e.englishSection??`A`);let n=(e.topic??`all`).trim();return!n||n===`all`?`### Your plan
- Pick a topic to focus your practice.
- Skim the overview (formulas / theory).
- Hit **Questions** to start.

**Subject:** ${t}`:e.subjectId===`methods`?be(n)||`### ${n}
...
**Subject:** Mathematical Methods`:e.subjectId===`general-maths`?R(n)||`### ${n}
...
**Subject:** Specialist Mathematics`:Ne(t)?`### ${n}
...
- Not linking evidence back to the question wording`}function Fe(e){return Array.from(new Set(e.map(e=>e.trim()).filter(Boolean))).sort((e,t)=>e.localeCompare(t))}function Ie(){let{subjectId:t}=te(),o=a(),{user:s}=re(),c=n(s),[h]=ne();(0,O.useEffect)(()=>{String(t)===`demo`&&!c&&o(`/dashboard`,{replace:!0})},[t,c,o]);let g=(0,O.useMemo)(()=>c?ce({isAdmin:c}):le,[c]),y=(0,O.useMemo)(()=>g.find(e=>String(e.id)===String(t)),[g,t]),[b,x]=(0,O.useState)(!0),[S,D]=(0,O.useState)([]),A=String(t)===`english`,j=String(h.get(`topic`)??`all`),M=String(h.get(`section`)??`A`).toUpperCase()||`A`,[N,P]=(0,O.useState)(j||`all`),[F,I]=(0,O.useState)(M===`B`||M===`C`?M:`A`);(0,O.useEffect)(()=>{if(!t)return;let n=!1;return(async()=>{try{if(x(!0),!s){D(C([],t));return}let a=await e(r.bootstrap);if(n)return;a.customQuestions&&localStorage.setItem(i.customQuestions,JSON.stringify(a.customQuestions)),D(C(w(a.customQuestions,t),t))}catch{let e=[];try{e=C(w(JSON.parse(localStorage.getItem(i.customQuestions)||`{}`),t),t)}catch{e=C([],t)}D(e)}finally{n||x(!1)}})(),()=>{n=!0}},[t,s]);let L=String(t)===`methods`,R=String(t)===`general-maths`,z=String(t)===`specialist-maths`,B=(0,O.useMemo)(()=>A?[]:L?se():R?_():z?v():[`all`,...Fe(S.map(e=>e.topic??`General`))],[S,A,L,R,z]),V=(0,O.useMemo)(()=>t?A?$({subjectId:t,subject:y,topic:N,englishSection:F}):!N||N===`all`?null:$({subjectId:t,subject:y,topic:N,englishSection:F}):null,[t,y,N,F,A]);return(0,O.useEffect)(()=>{A||B.length&&!B.includes(N)&&P(`all`)},[B,N,A]),(0,k.jsx)(ie,{title:y?`${y.name} Practice`:`Practice`,subtitle:`Choose your focus, then start questions.`,edgeToEdgeHeader:!0,edgeToEdgeMain:!0,children:(0,k.jsxs)(`div`,{className:`mx-auto w-full max-w-6xl space-y-5 sm:space-y-6`,children:[(0,k.jsxs)(E,{className:`practice-card`,children:[(0,k.jsx)(`div`,{className:`practice-card-header`,children:(0,k.jsx)(`p`,{className:`practice-card-header-title`,children:`Practice setup`})}),(0,k.jsxs)(T,{className:`flex flex-col gap-4 bg-[#f3f4f6]/30 px-4 py-5 sm:px-7 sm:py-6 lg:flex-row lg:items-center lg:justify-between lg:gap-6`,children:[(0,k.jsxs)(`div`,{className:`min-w-0`,children:[(0,k.jsx)(`p`,{className:`font-display text-lg font-semibold tracking-tight text-[#0b0f19] sm:text-xl`,children:y?.name??`Subject`}),(0,k.jsx)(`p`,{className:`mt-1 text-sm leading-relaxed text-muted-foreground`,children:`Pick a topic / section, then start questions.`})]}),(0,k.jsxs)(`div`,{className:`flex w-full flex-col gap-3 sm:flex-row sm:items-end sm:justify-end lg:gap-3`,children:[b?(0,k.jsxs)(`div`,{className:`flex items-center gap-2 rounded-xl border border-black/8 bg-[#f3f4f6] px-4 py-3 text-sm text-muted-foreground`,children:[(0,k.jsx)(ae,{className:`size-4 animate-spin`}),`Loading…`]}):A?(0,k.jsxs)(`div`,{className:`w-full min-w-0 space-y-2 sm:min-w-[260px]`,children:[(0,k.jsx)(`p`,{className:`text-[0.6875rem] font-semibold uppercase tracking-[0.12em] text-muted-foreground`,children:`English section`}),(0,k.jsxs)(p,{value:F,onValueChange:e=>I(e??`A`),children:[(0,k.jsx)(u,{className:`h-11 rounded-xl border-brand-light/50 bg-brand-light/50 text-[#0b0f19]`,children:(0,k.jsx)(l,{placeholder:`Choose section`})}),(0,k.jsxs)(d,{alignItemWithTrigger:!1,children:[(0,k.jsx)(f,{value:`A`,children:`Section A — Text response`}),(0,k.jsx)(f,{value:`B`,children:`Section B — Creative`}),(0,k.jsx)(f,{value:`C`,children:`Section C — Writing`})]})]})]}):(0,k.jsxs)(`div`,{className:`w-full min-w-0 space-y-2 sm:min-w-[260px]`,children:[(0,k.jsx)(`p`,{className:`text-[0.6875rem] font-semibold uppercase tracking-[0.12em] text-muted-foreground`,children:`Topic`}),(0,k.jsxs)(p,{value:N,onValueChange:e=>P(e??`all`),children:[(0,k.jsx)(u,{className:`h-11 rounded-xl border-brand-light/50 bg-brand-light/50 text-[#0b0f19]`,children:(0,k.jsx)(l,{placeholder:`Choose topic`})}),(0,k.jsx)(d,{alignItemWithTrigger:!1,className:`max-h-72`,children:B.map(e=>(0,k.jsx)(f,{value:e,children:e===`all`?`All topics`:e},e))})]})]}),(0,k.jsxs)(ee,{variant:`accent`,onClick:()=>{if(t){if(A){o(`/quiz/english?section=${encodeURIComponent(F)}`);return}o(`/quiz/${t}${N&&N!==`all`?`?topic=${encodeURIComponent(N)}`:``}`)}},className:`h-11 w-full gap-2 rounded-xl sm:w-auto`,children:[(0,k.jsx)(m,{className:`size-4`}),`Questions`,(0,k.jsx)(oe,{className:`size-4`})]})]})]})]}),(0,k.jsxs)(E,{className:`practice-card`,children:[(0,k.jsx)(`div`,{className:`practice-card-header`,children:(0,k.jsx)(`p`,{className:`practice-card-header-title`,children:`Study overview`})}),(0,k.jsx)(T,{className:`px-4 py-5 sm:px-7 sm:py-6`,children:V?(0,k.jsx)(ue,{markdown:V}):(0,k.jsx)(`div`,{className:`rounded-2xl border border-dashed border-black/15 bg-[#0b0f19]/[0.03] p-8 text-center`,children:(0,k.jsx)(`p`,{className:`text-sm font-medium text-muted-foreground`,children:`Choose a topic above to load overview notes.`})})})]})]})})}export{Ie as default};