import{$ as e,Q as t,W as n,Z as r,et as i,rt as a,t as o}from"./button-BEh2Hzxd.js";import{g as ee,h as te,i as ne,r as re,y as ie}from"./api-DRHldfqW.js";import{n as s}from"./AuthContext-Bw_UlkJK.js";import{t as c}from"./AppShell-D7pXRte3.js";import{n as l}from"./utils-C4pgb95X.js";import{t as u}from"./book-open-ClSc7Ugg.js";import{t as d}from"./file-text-DUVocHN8.js";import{t as ae}from"./loader-circle-6UL43xXd.js";import{L as f,V as oe}from"./index-BwJeQXpe.js";import{C as p,E as m,S as h,_ as g,h as _,v,w as se,x as ce,y}from"./practiceQuestions-Dcp_0w_t.js";import{n as b}from"./questionBankCache-CphdKMgF.js";import{n as le,t as ue}from"./card-BoS7Piyd.js";import{n as de,t as fe}from"./subjects-B9PbZhWb.js";import{t as x}from"./RichQuestionContent-CvfNjfXM.js";import{i as S,n as pe,t as C}from"./premium-DbBQGiaT.js";import{r as me}from"./premiumUsage-BZ9Yz4ii.js";import{i as w,n as he,r as ge,t as _e}from"./tabs-BoKHZo_3.js";import{t as ve}from"./TopicPerformanceSelect-DMpCiQ6M.js";var T=a(i(),1),E=n();function ye({markdown:e,className:t}){return(0,E.jsx)(`div`,{className:l(`curriculum-overview relative overflow-hidden rounded-2xl`,`border border-black/10 border-l-4 border-l-brand-light/70 bg-[#f3f4f6]/50`,`px-5 py-7 sm:rounded-3xl sm:px-8 sm:py-9`,`text-[#0b0f19] antialiased`,`[&_.katex-error]:hidden`,`[&_a]:font-medium [&_a]:text-brand-deep [&_a]:underline [&_a]:decoration-brand/45 [&_a]:decoration-1 [&_a]:underline-offset-[3px] [&_a]:transition-colors hover:[&_a]:text-brand hover:[&_a]:decoration-brand`,t),children:(0,E.jsx)(x,{text:e,preferMarkdown:!0,overviewMode:!0})})}var D=`### Types of data
...
`,j=e=>String(e??``).trim().toLowerCase().replace(/\s+/g,` `),M={statistics:`Data analysis`,"data analysis, probability and statistics":`Data analysis`,finance:`Recursion and financial modelling`,sequences:`Recursion and financial modelling`,recursion:`Recursion and financial modelling`,matrices:`Matrices`,matrix:`Matrices`,networks:`Networks and decision mathematics`,graphs:`Networks and decision mathematics`,"discrete mathematics":`Matrices`,"algebra, number and structure":`Recursion and financial modelling`,"functions, relations and graphs":`Data analysis`,"space and measurement":`Data analysis`};function N(e,t,n){return`${e}

**Area:** ${t}

---

${n}`}var P={"Data analysis":N(`## Data analysis`,`Data analysis`,D),"Recursion and financial modelling":N(`## Recursion and financial modelling`,`Recursion and financial modelling`,`**Sequences** where each term depends on the previous term — used heavily in **finance**, loans, and investments.

${O}`),Matrices:N(`## Matrices`,`Matrices`,`Organising numbers in **arrays** to model transitions, networks, and systems.

${k}`),"Networks and decision mathematics":N(`## Networks and decision mathematics`,`Networks and decision mathematics`,`**Graphs**, **paths**, **optimisation**, and **scheduling**.

${A}`)};function F(e){let t=String(e??``).trim();if(!t)return null;let n=m(t);if(Object.prototype.hasOwnProperty.call(P,n))return P[n];let r=j(n),i=M[r]??M[j(t)];if(i)return P[i]??null;for(let e of p)if(j(e)===r||j(e)===j(t))return P[e];return null}var I=`A function takes an input $x$ and gives exactly one output $y$: $y = f(x)$.
...
`,V=`Calculus studies **change** (differentiation) and **accumulation** (integration).
...
`,xe=`### Continuous random variables
...
`,G=`### Confidence intervals for proportions
...
`,K=e=>String(e??``).trim().toLowerCase().replace(/\s+/g,` `),q={"functions, relations and graphs":`Functions and transformations`,calculus:`Differential calculus`,"algebra, number and structure":`Algebra and equations`,probability:`Discrete random variables`,statistics:`Sampling and sample proportions`,trigonometry:`Circular functions`};function J(e,t,n){return`${e}

**Area:** ${t}

---

${n}`}var Y={"Functions and transformations":J(`## Functions and transformations`,`Functions, relations and graphs`,I),"Polynomial, power and rational functions":J(`## Polynomial, power and rational functions`,`Functions, relations and graphs`,L),"Exponential and logarithmic functions":J(`## Exponential and logarithmic functions`,`Functions, relations and graphs`,R),"Circular functions":J(`## Circular functions`,`Functions, relations and graphs`,z),"Algebra and equations":J(`## Algebra and equations`,`Algebra`,B),"Differential calculus":J(`## Differential calculus`,`Calculus`,V),"Applications of differentiation":J(`## Applications of differentiation`,`Calculus`,H),"Integral calculus":J(`## Integral calculus`,`Calculus`,U),"Applications of integration":J(`## Applications of integration`,`Calculus`,W),"Discrete random variables":J(`## Discrete random variables`,`Probability and statistics`,be),"Continuous random variables":J(`## Continuous random variables`,`Probability and statistics`,xe),"The normal distribution":J(`## The normal distribution`,`Probability and statistics`,Se),"Sampling and sample proportions":J(`## Sampling and sample proportions`,`Probability and statistics`,Ce),"Confidence intervals for proportions":J(`## Confidence intervals for proportions`,`Probability and statistics`,G)};function we(e){let t=String(e??``).trim();if(!t)return null;let n=h(t);if(Object.prototype.hasOwnProperty.call(Y,n))return Y[n];let r=K(n),i=q[r]??q[K(t)];if(i)return Y[i]??null;for(let e of y)if(K(e)===r||K(e)===K(t))return Y[e];return null}var Te=`### Logic and statements
...
`,X=e=>String(e??``).trim().toLowerCase().replace(/\s+/g,` `),Z={"proof and number":`Logic and proof`,"graph theory":`Logic and proof`,"logic and algorithms":`Logic and proof`,"complex numbers":`Complex numbers and algebra`,calculus:`Differential calculus`,statistics:`Random variables and sampling`,probability:`Random variables and sampling`,"probability and statistics: random variables and sampling":`Random variables and sampling`};function Q(e,t,n){return`${e}

**Area:** ${t}

---

${n}`}var $={"Logic and proof":Q(`## Logic and proof`,`Discrete mathematics`,`Making mathematical arguments precise — statements, proof styles, and induction.

${Te}`),"Complex numbers and algebra":Q(`## Complex numbers and algebra`,`Algebra, number and structure`,`Complex arithmetic, polar form, De Moivre’s theorem, and roots.

${De}`),"Functions, relations and graphs":Q(`## Functions, relations and graphs`,`Functions, relations and graphs`,`Rational functions, partial fractions, parametric and polar graphs.

${Ee}`),"Differential calculus":Q(`## Differential calculus`,`Calculus`,`Advanced differentiation — rules, implicit differentiation, and related rates.

${Oe}`),"Integral calculus":Q(`## Integral calculus`,`Calculus`,`Integration techniques and when to use them.

${ke}`),"Differential equations":Q(`## Differential equations`,`Calculus`,`Equations involving derivatives — modelling and separable solutions.

${Ae}`),Kinematics:Q(`## Kinematics`,`Calculus / mechanics`,`Position, velocity and acceleration linked by calculus.

${je}`),"Vectors in two and three dimensions":Q(`## Vectors in two and three dimensions`,`Space and measurement`,`Vector operations, dot product, projection, and cross product.

${Me}`),"Lines and planes in 3D":Q(`## Lines and planes in 3D`,`Space and measurement`,`Lines and planes in 3D, normals, and distances.

${Ne}`),"Vector calculus":Q(`## Vector calculus`,`Space and measurement`,`Vector functions of time and parametric motion.

${Pe}`),"Random variables and sampling":Q(`## Random variables and sampling`,`Data analysis, probability and statistics`,`Random variables, binomial and normal models, and sample means.

${Fe}`),"Confidence intervals":Q(`## Confidence intervals`,`Data analysis, probability and statistics`,`Estimate a population mean — plus exam strategy and key formulas.

${Ie}`)};function Le(e){let t=String(e??``).trim();if(!t)return null;let n=v(t);if(Object.prototype.hasOwnProperty.call($,n))return $[n];let r=X(n),i=Z[r]??Z[X(t)];if(i)return $[i]??null;for(let e of _)if(X(e)===r||X(e)===X(t))return $[e];return null}function Re(e){return/math|methods|specialist|further/i.test(e)}function ze(e){return e===`A`?`### Section A — Analytical response to a text
...
By describing the proposal as a “smarter investment”, the writer positions the audience to view the change as practical and responsible, strengthening support for their overall contention.`}function Be(e){let t=e.subject?.name??e.subjectId;if(e.subjectId===`english`)return ze(e.englishSection??`A`);let n=(e.topic??`all`).trim();return!n||n===`all`?`### Your plan
...
**Subject:** Mathematical Methods`:e.subjectId===`general-maths`||e.subjectId===`demo`?F(n)||`### ${n}
...
- Not linking evidence back to the question wording`}function Ve(e){return Array.from(new Set(e.map(e=>e.trim()).filter(Boolean))).sort((e,t)=>e.localeCompare(t))}function He(){let{subjectId:n}=t(),i=r(),{user:a}=s(),l=ie(a),p=pe(a),m=S(a),[h,_]=e();(0,T.useEffect)(()=>{String(n)===`demo`&&!l&&i(`/dashboard`,{replace:!0})},[n,l,i]);let v=(0,T.useMemo)(()=>l?de({isAdmin:l}):fe,[l]),y=(0,T.useMemo)(()=>v.find(e=>String(e.id)===String(n)),[v,n]),[x,D]=(0,T.useState)(!0),[O,k]=(0,T.useState)([]),A=String(n)===`english`;(0,T.useEffect)(()=>{A&&i(`/quiz/english`,{replace:!0})},[A,i]);let[j,M]=(0,T.useState)(String(h.get(`topic`)??`all`)||`all`),N=String(h.get(`kind`)??`mixed`).trim()||`mixed`,[P,F]=(0,T.useState)(()=>{let e=[`mixed`,`mcq`,`sa`,`la`,`exams`].includes(N)?N:`mixed`;return e===`la`&&!m||e===`exams`&&!p?`mixed`:e});(0,T.useEffect)(()=>{let e=String(h.get(`topic`)??`all`)||`all`;M(t=>t===e?t:e)},[h]),(0,T.useEffect)(()=>{let e=String(h.get(`kind`)??`mixed`).trim().toLowerCase();if(e&&e!==P&&(e===`mixed`||e===`mcq`||e===`sa`||e===`la`||e===`exams`)){if(e===`la`&&!m){F(`mixed`);return}F(e)}},[h,P,m]),(0,T.useEffect)(()=>{m||P===`la`&&(F(`mixed`),_(e=>{let t=new URLSearchParams(e);return t.delete(`kind`),t},{replace:!0}))},[m,P,_]);let I=e=>{M(e),_(t=>{let n=new URLSearchParams(t);return!e||e===`all`?n.delete(`topic`):n.set(`topic`,e),n},{replace:!0})},L=e=>{if(e===`la`&&!m){i(C);return}if(e===`exams`&&!p){i(C);return}F(e),_(t=>{let n=new URLSearchParams(t);return!e||e===`mixed`?n.delete(`kind`):n.set(`kind`,e),n},{replace:!0})};(0,T.useEffect)(()=>{if(!n)return;let e=!1,t=b(n);if(t.length>0)k(t),D(!1);else if(a)D(!0);else{k(b(n)),D(!1);return}if(a)return(async()=>{try{let t=await ne(te.bootstrap,{timeoutMs:re});if(e)return;t.customQuestions&&localStorage.setItem(ee.customQuestions,JSON.stringify(t.customQuestions)),k(b(n))}catch{if(e)return;k(b(n))}finally{e||D(!1)}})(),()=>{e=!0}},[n,a]);let R=String(n)===`methods`,z=String(n)===`general-maths`||String(n)===`demo`,B=String(n)===`specialist-maths`,V=(0,T.useMemo)(()=>A?[]:R?ce():z?se():B?g():[`all`,...Ve(O.map(e=>e.topic??`General`))],[O,A,R,z,B]),H=(0,T.useMemo)(()=>V.filter(e=>e!==`all`),[V]),U=(0,T.useMemo)(()=>!n||A||!j||j===`all`?null:Be({subjectId:n,subject:y,topic:j}),[n,y,j,A]);(0,T.useEffect)(()=>{A||V.length&&!V.includes(j)&&M(`all`)},[V,j,A]);let W=()=>{if(!n)return;if(A){i(`/quiz/english`);return}if(P===`la`&&!m){i(C);return}if(P===`exams`){if(!p){i(C);return}i(`/practice/${n}/exams`);return}let e=new URLSearchParams;j&&j!==`all`&&e.set(`topic`,j),P&&P!==`mixed`&&e.set(`kind`,P),i(`/quiz/${n}${e.toString()?`?${e.toString()}`:``}`)};return(0,E.jsx)(c,{title:`Practice`,edgeToEdgeHeader:!0,edgeToEdgeMain:!0,children:(0,E.jsx)(`div`,{className:`mx-auto w-full max-w-6xl space-y-5 sm:space-y-6`,children:(0,E.jsx)(ue,{className:`practice-card`,children:(0,E.jsx)(le,{className:`bg-[#f3f4f6]/30 px-4 py-8 sm:px-7 sm:py-10`,children:(0,E.jsxs)(`div`,{className:`mx-auto flex min-h-[min(32rem,70vh)] w-full max-w-4xl flex-col`,children:[(0,E.jsx)(`div`,{className:`text-center`,children:(0,E.jsx)(`p`,{className:`font-display text-2xl font-semibold tracking-tight text-[#0b0f19] sm:text-3xl`,children:y?.name??`Practice`})}),(0,E.jsx)(`div`,{className:`mt-7 flex flex-1 flex-col sm:mt-9`,children:x?(0,E.jsxs)(`div`,{className:`flex items-center justify-center gap-2 rounded-2xl border border-black/8 bg-white px-5 py-4 text-sm text-muted-foreground`,children:[(0,E.jsx)(ae,{className:`size-4 animate-spin`}),`Loading…`]}):A?(0,E.jsx)(`p`,{className:`text-center text-sm text-muted-foreground`,children:`Redirecting…`}):(0,E.jsxs)(E.Fragment,{children:[(0,E.jsxs)(`div`,{className:`mx-auto flex w-full max-w-3xl flex-col items-center gap-4`,children:[(0,E.jsxs)(`div`,{className:`w-full`,children:[(0,E.jsx)(`p`,{className:`mb-2 text-center text-[0.6875rem] font-semibold uppercase tracking-[0.12em] text-muted-foreground`,children:`Practice mode`}),(0,E.jsxs)(_e,{value:P,onValueChange:e=>L(e),children:[(0,E.jsxs)(ge,{className:`mx-auto w-full max-w-3xl justify-between`,children:[(0,E.jsx)(w,{value:`mixed`,children:`Mixed`}),(0,E.jsx)(w,{value:`mcq`,children:`MCQ`}),(0,E.jsx)(w,{value:`sa`,children:`SA`}),(0,E.jsx)(w,{value:`la`,"aria-disabled":!m,children:m?`LA`:`LA (Premium)`}),(0,E.jsx)(w,{value:`exams`,"aria-disabled":!p,children:p?`Exams`:`Exams (Premium)`})]}),(0,E.jsx)(he,{value:P,className:`mt-3`,children:(0,E.jsx)(`div`,{className:`rounded-2xl border border-black/8 bg-white px-4 py-3 text-sm text-muted-foreground`,children:P===`exams`?(0,E.jsxs)(`div`,{className:`flex items-start gap-2`,children:[(0,E.jsx)(`span`,{className:`mt-0.5`,children:p?(0,E.jsx)(d,{className:`size-4 text-foreground`}):(0,E.jsx)(f,{className:`size-4`})}),(0,E.jsxs)(`div`,{className:`min-w-0`,children:[(0,E.jsx)(`p`,{className:`font-medium text-foreground`,children:`Past practice exams`}),(0,E.jsx)(`p`,{className:`mt-0.5`,children:p?`Browse past papers by topic and attempt them like the real exam.`:`Premium only. Free accounts can practice MCQ and short answers.`})]})]}):P===`mcq`?(0,E.jsx)(`p`,{children:`Multiple choice only. Fast reps + quick confidence building.`}):P===`sa`?(0,E.jsx)(`p`,{children:`Short answer only. Free includes 3 AI marks/day, then unlimited keyword matching with generic feedback.`}):P===`la`?(0,E.jsxs)(`div`,{className:`flex items-start gap-2`,children:[(0,E.jsx)(f,{className:`mt-0.5 size-4 shrink-0`}),(0,E.jsxs)(`div`,{children:[(0,E.jsx)(`p`,{className:`font-medium text-foreground`,children:`Long-answer practice`}),(0,E.jsx)(`p`,{className:`mt-0.5`,children:m?`Full working, mark breakdown, and harder reasoning.`:`Premium only. Free accounts use MCQ and short-answer practice.`})]})]}):(0,E.jsx)(`p`,{children:m?`Mixed practice. We’ll rotate question styles while staying on your chosen topic.`:`Mixed MCQ and short answers (no long answers on Free).`})})})]}),(0,E.jsxs)(`div`,{className:`mt-3 rounded-2xl border border-black/8 bg-white px-4 py-3 text-left text-sm`,children:[(0,E.jsx)(`p`,{className:`font-semibold text-[#0b0f19]`,children:`Your plan limits`}),m?(0,E.jsx)(`p`,{className:`mt-1 text-muted-foreground`,children:`Premium: Unlimited topic practice, unlimited AI marking, Ask AI, and full practice exams.`}):(0,E.jsxs)(`p`,{className:`mt-1 text-muted-foreground`,children:[`Free: `,me(),` · exams not included.`,(0,E.jsx)(`button`,{type:`button`,className:`ml-1 font-semibold text-brand-dark hover:underline`,onClick:()=>i(C),children:`View Premium`})]})]})]}),(0,E.jsxs)(`div`,{className:`flex w-full flex-col items-stretch gap-3 sm:flex-row sm:items-start sm:justify-center`,children:[(0,E.jsxs)(`div`,{className:`w-full sm:w-[18rem]`,children:[(0,E.jsx)(`p`,{className:`mb-2 text-center text-[0.6875rem] font-semibold uppercase tracking-[0.12em] text-muted-foreground`,children:`Topic`}),(0,E.jsx)(ve,{subjectId:n,value:j,onValueChange:I,topics:H,includeAllOption:!0,placeholder:`Choose topic`,className:`w-full sm:w-[18rem]`})]}),(0,E.jsxs)(`div`,{className:`w-full sm:w-[18rem]`,children:[(0,E.jsx)(`p`,{className:`mb-2 text-center text-[0.6875rem] font-semibold uppercase tracking-[0.12em] text-transparent`,"aria-hidden":!0,children:`Topic`}),(0,E.jsxs)(o,{variant:`accent`,onClick:W,className:`h-12 w-full gap-2 rounded-2xl text-base sm:w-[18rem]`,children:[P===`exams`?p?(0,E.jsx)(d,{className:`size-4`}):(0,E.jsx)(f,{className:`size-4`}):(0,E.jsx)(u,{className:`size-4`}),P===`exams`?p?`Open exams`:`Premium exams`:`Start practice`,(0,E.jsx)(oe,{className:`size-4`})]})]})]})]}),(0,E.jsx)(`div`,{className:`mt-10 flex flex-1 flex-col justify-center`,children:U?(0,E.jsx)(ye,{markdown:U}):(0,E.jsx)(`p`,{className:`text-center text-sm text-muted-foreground sm:text-base`,children:`Choose what to revise`})})]})})]})})})})})}export{He as default};