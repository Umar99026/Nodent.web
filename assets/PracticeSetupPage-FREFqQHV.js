import{Kt as e,Qt as t,Ut as n,Xt as r,Zt as i,an as a,fn as o,ln as s,n as ee,on as te,sn as ne,u as c}from"./NodentWordmark-B2egDhHz.js";import{R as re}from"./DirectionContext-DojB8UAq.js";import{t as ie}from"./AppShell-CwjuNaoZ.js";import{a as l,i as u,n as d,r as f,t as p}from"./select-DBTp5B0g.js";import{t as ae}from"./loader-circle-CTwlCT3y.js";import{c as oe,s as m}from"./index-mIFY-1H0.js";import{A as h,F as g,I as _,L as v,M as y,N as b,P as se,R as x,j as S,o as C,r as w}from"./practiceQuestions-Chb-hZi8.js";import{n as T,t as E}from"./card-QaDSAUHr.js";import{n as ce,t as le}from"./subjects-Y2QW-OeV.js";import{r as D}from"./QuestionStimulus-CMk3DxQD.js";var O=o(s(),1),k=n();function ue({markdown:e,className:t}){return(0,k.jsx)(`div`,{className:c(`curriculum-overview relative overflow-hidden rounded-2xl`,`border border-black/10 border-l-4 border-l-brand-light/70 bg-[#f3f4f6]/50`,`px-5 py-7 sm:rounded-3xl sm:px-8 sm:py-9`,`text-[#0b0f19] antialiased`,`[&_.katex-error]:hidden`,`[&_a]:font-medium [&_a]:text-brand-deep [&_a]:underline [&_a]:decoration-brand/45 [&_a]:decoration-1 [&_a]:underline-offset-[3px] [&_a]:transition-colors hover:[&_a]:text-brand hover:[&_a]:decoration-brand`,t),children:(0,k.jsx)(D,{text:e,preferMarkdown:!0,overviewMode:!0})})}var A=`### Types of data
...
${N}`)};function R(e){let t=String(e??``).trim();if(!t)return null;let n=x(t);if(Object.prototype.hasOwnProperty.call(L,n))return L[n];let r=P(n),i=F[r]??F[P(t)];if(i)return L[i]??null;for(let e of _)if(P(e)===r||P(e)===P(t))return L[e];return null}var z=`A function takes an input $x$ and gives exactly one output $y$: $y = f(x)$.
...
${n}`}var q={"Functions and transformations":K(`## Functions and transformations`,`Functions, relations and graphs`,z),"Polynomial, power and rational functions":K(`## Polynomial, power and rational functions`,`Functions, relations and graphs`,B),"Exponential and logarithmic functions":K(`## Exponential and logarithmic functions`,`Functions, relations and graphs`,V),"Circular functions":K(`## Circular functions`,`Functions, relations and graphs`,H),"Algebra and equations":K(`## Algebra and equations`,`Algebra`,U),"Differential calculus":K(`## Differential calculus`,`Calculus`,de),"Applications of differentiation":K(`## Applications of differentiation`,`Calculus`,fe),"Integral calculus":K(`## Integral calculus`,`Calculus`,pe),"Applications of integration":K(`## Applications of integration`,`Calculus`,me),"Discrete random variables":K(`## Discrete random variables`,`Probability and statistics`,he),"Continuous random variables":K(`## Continuous random variables`,`Probability and statistics`,ge),"The normal distribution":K(`## The normal distribution`,`Probability and statistics`,_e),"Sampling and sample proportions":K(`## Sampling and sample proportions`,`Probability and statistics`,ve),"Confidence intervals for proportions":K(`## Confidence intervals for proportions`,`Probability and statistics`,ye)};function be(e){let t=String(e??``).trim();if(!t)return null;let n=g(t);if(Object.prototype.hasOwnProperty.call(q,n))return q[n];let r=W(n),i=G[r]??G[W(t)];if(i)return q[i]??null;for(let e of b)if(W(e)===r||W(e)===W(t))return q[e];return null}var xe=`### Logic and statements
...
- Not linking evidence back to the question wording`}function Fe(e){return Array.from(new Set(e.map(e=>e.trim()).filter(Boolean))).sort((e,t)=>e.localeCompare(t))}function Ie(){let{subjectId:n}=te(),o=a(),{user:s}=re(),c=t(s),[h]=ne();(0,O.useEffect)(()=>{String(n)===`demo`&&!c&&o(`/dashboard`,{replace:!0})},[n,c,o]);let g=(0,O.useMemo)(()=>c?ce({isAdmin:c}):le,[c]),_=(0,O.useMemo)(()=>g.find(e=>String(e.id)===String(n)),[g,n]),[y,b]=(0,O.useState)(!0),[x,D]=(0,O.useState)([]),A=String(n)===`english`,j=String(h.get(`topic`)??`all`),M=String(h.get(`section`)??`A`).toUpperCase()||`A`,[N,P]=(0,O.useState)(j||`all`),[F,I]=(0,O.useState)(M===`B`||M===`C`?M:`A`);(0,O.useEffect)(()=>{if(!n)return;let t=!1;return(async()=>{try{if(b(!0),!s){D(C([],n));return}let a=await e(r.bootstrap);if(t)return;a.customQuestions&&localStorage.setItem(i.customQuestions,JSON.stringify(a.customQuestions)),D(C(w(a.customQuestions,n),n))}catch{let e=[];try{e=C(w(JSON.parse(localStorage.getItem(i.customQuestions)||`{}`),n),n)}catch{e=C([],n)}D(e)}finally{t||b(!1)}})(),()=>{t=!0}},[n,s]);let L=String(n)===`methods`,R=String(n)===`general-maths`,z=String(n)===`specialist-maths`,B=(0,O.useMemo)(()=>A?[]:L?se():R?v():z?S():[`all`,...Fe(x.map(e=>e.topic??`General`))],[x,A,L,R,z]),V=(0,O.useMemo)(()=>n?A?$({subjectId:n,subject:_,topic:N,englishSection:F}):!N||N===`all`?null:$({subjectId:n,subject:_,topic:N,englishSection:F}):null,[n,_,N,F,A]);return(0,O.useEffect)(()=>{A||B.length&&!B.includes(N)&&P(`all`)},[B,N,A]),(0,k.jsx)(ie,{title:_?`${_.name} Practice`:`Practice`,subtitle:`Choose your focus, then start questions.`,edgeToEdgeHeader:!0,edgeToEdgeMain:!0,children:(0,k.jsxs)(`div`,{className:`mx-auto w-full max-w-6xl space-y-5 sm:space-y-6`,children:[(0,k.jsxs)(E,{className:`practice-card`,children:[(0,k.jsx)(`div`,{className:`practice-card-header`,children:(0,k.jsx)(`p`,{className:`practice-card-header-title`,children:`Practice setup`})}),(0,k.jsxs)(T,{className:`flex flex-col gap-4 bg-[#f3f4f6]/30 px-4 py-5 sm:px-7 sm:py-6 lg:flex-row lg:items-center lg:justify-between lg:gap-6`,children:[(0,k.jsxs)(`div`,{className:`min-w-0`,children:[(0,k.jsx)(`p`,{className:`font-display text-lg font-semibold tracking-tight text-[#0b0f19] sm:text-xl`,children:_?.name??`Subject`}),(0,k.jsx)(`p`,{className:`mt-1 text-sm leading-relaxed text-muted-foreground`,children:`Pick a topic / section, then start questions.`})]}),(0,k.jsxs)(`div`,{className:`flex w-full flex-col gap-3 sm:flex-row sm:items-end sm:justify-end lg:gap-3`,children:[y?(0,k.jsxs)(`div`,{className:`flex items-center gap-2 rounded-xl border border-black/8 bg-[#f3f4f6] px-4 py-3 text-sm text-muted-foreground`,children:[(0,k.jsx)(ae,{className:`size-4 animate-spin`}),`Loading…`]}):A?(0,k.jsxs)(`div`,{className:`w-full min-w-0 space-y-2 sm:min-w-[260px]`,children:[(0,k.jsx)(`p`,{className:`text-[0.6875rem] font-semibold uppercase tracking-[0.12em] text-muted-foreground`,children:`English section`}),(0,k.jsxs)(p,{value:F,onValueChange:e=>I(e??`A`),children:[(0,k.jsx)(u,{className:`h-11 rounded-xl border-brand-light/50 bg-brand-light/50 text-[#0b0f19]`,children:(0,k.jsx)(l,{placeholder:`Choose section`})}),(0,k.jsxs)(d,{alignItemWithTrigger:!1,children:[(0,k.jsx)(f,{value:`A`,children:`Section A — Text response`}),(0,k.jsx)(f,{value:`B`,children:`Section B — Creative`}),(0,k.jsx)(f,{value:`C`,children:`Section C — Writing`})]})]})]}):(0,k.jsxs)(`div`,{className:`w-full min-w-0 space-y-2 sm:min-w-[260px]`,children:[(0,k.jsx)(`p`,{className:`text-[0.6875rem] font-semibold uppercase tracking-[0.12em] text-muted-foreground`,children:`Topic`}),(0,k.jsxs)(p,{value:N,onValueChange:e=>P(e??`all`),children:[(0,k.jsx)(u,{className:`h-11 rounded-xl border-brand-light/50 bg-brand-light/50 text-[#0b0f19]`,children:(0,k.jsx)(l,{placeholder:`Choose topic`})}),(0,k.jsx)(d,{alignItemWithTrigger:!1,className:`max-h-72`,children:B.map(e=>(0,k.jsx)(f,{value:e,children:e===`all`?`All topics`:e},e))})]})]}),(0,k.jsxs)(ee,{variant:`accent`,onClick:()=>{if(n){if(A){o(`/quiz/english?section=${encodeURIComponent(F)}`);return}o(`/quiz/${n}${N&&N!==`all`?`?topic=${encodeURIComponent(N)}`:``}`)}},className:`h-11 w-full gap-2 rounded-xl sm:w-auto`,children:[(0,k.jsx)(m,{className:`size-4`}),`Questions`,(0,k.jsx)(oe,{className:`size-4`})]})]})]})]}),(0,k.jsxs)(E,{className:`practice-card`,children:[(0,k.jsx)(`div`,{className:`practice-card-header`,children:(0,k.jsx)(`p`,{className:`practice-card-header-title`,children:`Study overview`})}),(0,k.jsx)(T,{className:`px-4 py-5 sm:px-7 sm:py-6`,children:V?(0,k.jsx)(ue,{markdown:V}):(0,k.jsx)(`div`,{className:`rounded-2xl border border-dashed border-black/15 bg-[#0b0f19]/[0.03] p-8 text-center`,children:(0,k.jsx)(`p`,{className:`text-sm font-medium text-muted-foreground`,children:`Choose a topic above to load overview notes.`})})})]})]})})}export{Ie as default};