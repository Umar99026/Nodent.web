import{Gt as e,Ht as t,Xt as n,Yt as r,Zt as i,an as a,fn as o,in as ee,ln as s,n as te,on as ne,u as c}from"./NodentWordmark-HnQ-8zIW.js";import{R as re}from"./DirectionContext-duEygluo.js";import{t as l}from"./AppShell-DSEoJQyE.js";import{a as u,i as d,n as f,r as p,t as m}from"./select-BY_EZ2dp.js";import{t as h}from"./loader-circle-BHDbht3g.js";import{a as ie,n as ae,o as g}from"./index-BRZPJBt3.js";import{C as _,D as oe,E as v,O as y,S as b,T as x,b as S,o as C,r as w,w as se,x as ce}from"./practiceQuestions-pqXJ6dST.js";import{t as T}from"./RichQuestionContent-BgtmRTxH.js";import{a as E,n as D,o as le,t as O}from"./card-B_U7Tr7Y.js";import{t as ue}from"./badge-Lmwp9GmW.js";import{n as de,t as fe}from"./subjects-J9LuY-j1.js";var k=o(s(),1),A=t();function pe({markdown:e,className:t}){return(0,A.jsxs)(`div`,{className:c(`curriculum-overview relative overflow-hidden rounded-2xl`,`border border-slate-200/80 bg-gradient-to-b from-white via-white to-slate-50/60`,`px-5 py-7 shadow-[0_1px_2px_rgba(15,23,42,0.04),0_16px_48px_-20px_rgba(15,23,42,0.12)]`,`ring-1 ring-black/[0.04] sm:rounded-3xl sm:px-8 sm:py-9`,`text-slate-800 antialiased`,`[&_.katex-error]:hidden`,`[&_a]:font-medium [&_a]:text-brand-deep [&_a]:underline [&_a]:decoration-brand/45 [&_a]:decoration-1 [&_a]:underline-offset-[3px] [&_a]:transition-colors hover:[&_a]:text-brand hover:[&_a]:decoration-brand`,t),children:[(0,A.jsx)(`div`,{className:`pointer-events-none absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-brand/35 to-transparent`,"aria-hidden":!0}),(0,A.jsx)(T,{text:e,preferMarkdown:!0,overviewMode:!0})]})}var j=`### Types of data
...
${P}`)};function z(e){let t=String(e??``).trim();if(!t)return null;let n=y(t);if(Object.prototype.hasOwnProperty.call(R,n))return R[n];let r=F(n),i=I[r]??I[F(t)];if(i)return R[i]??null;for(let e of v)if(F(e)===r||F(e)===F(t))return R[e];return null}var B=`A function takes an input $x$ and gives exactly one output $y$: $y = f(x)$.
...
${n}`}var q={"Functions and transformations":K(`## Functions and transformations`,`Functions, relations and graphs`,B),"Polynomial, power and rational functions":K(`## Polynomial, power and rational functions`,`Functions, relations and graphs`,V),"Exponential and logarithmic functions":K(`## Exponential and logarithmic functions`,`Functions, relations and graphs`,H),"Circular functions":K(`## Circular functions`,`Functions, relations and graphs`,U),"Algebra and equations":K(`## Algebra and equations`,`Algebra`,me),"Differential calculus":K(`## Differential calculus`,`Calculus`,he),"Applications of differentiation":K(`## Applications of differentiation`,`Calculus`,ge),"Integral calculus":K(`## Integral calculus`,`Calculus`,_e),"Applications of integration":K(`## Applications of integration`,`Calculus`,ve),"Discrete random variables":K(`## Discrete random variables`,`Probability and statistics`,ye),"Continuous random variables":K(`## Continuous random variables`,`Probability and statistics`,be),"The normal distribution":K(`## The normal distribution`,`Probability and statistics`,xe),"Sampling and sample proportions":K(`## Sampling and sample proportions`,`Probability and statistics`,Se),"Confidence intervals for proportions":K(`## Confidence intervals for proportions`,`Probability and statistics`,Ce)};function we(e){let t=String(e??``).trim();if(!t)return null;let n=x(t);if(Object.prototype.hasOwnProperty.call(q,n))return q[n];let r=W(n),i=G[r]??G[W(t)];if(i)return q[i]??null;for(let e of _)if(W(e)===r||W(e)===W(t))return q[e];return null}var Te=`### Logic and statements
...
${J}`)};function Ie(e){let t=String(e??``).trim();if(!t)return null;let n=b(t);if(Object.prototype.hasOwnProperty.call(Q,n))return Q[n];let r=Y(n),i=X[r]??X[Y(t)];if(i)return Q[i]??null;for(let e of S)if(Y(e)===r||Y(e)===Y(t))return Q[e];return null}function Le(e){return/math|methods|specialist|further/i.test(e)}function Re(e){return e===`A`?`### Section A — Analytical response to a text
...
- Not linking evidence back to the question wording`}function ze(e){return Array.from(new Set(e.map(e=>e.trim()).filter(Boolean))).sort((e,t)=>e.localeCompare(t))}function Be(){let{subjectId:t}=a(),o=ee(),{user:s}=re(),c=i(s),[_]=ne();(0,k.useEffect)(()=>{String(t)===`demo`&&!c&&o(`/dashboard`,{replace:!0})},[t,c,o]);let v=(0,k.useMemo)(()=>c?de({isAdmin:c}):fe,[c]),y=(0,k.useMemo)(()=>v.find(e=>String(e.id)===String(t)),[v,t]),[b,x]=(0,k.useState)(!0),[S,T]=(0,k.useState)([]),j=String(t)===`english`,M=String(_.get(`topic`)??`all`),N=String(_.get(`section`)??`A`).toUpperCase()||`A`,[P,F]=(0,k.useState)(M||`all`),[I,L]=(0,k.useState)(N===`B`||N===`C`?N:`A`);(0,k.useEffect)(()=>{if(!t)return;let i=!1;return(async()=>{try{if(x(!0),!s){T(C([],t));return}let a=await e(r.bootstrap);if(i)return;a.customQuestions&&localStorage.setItem(n.customQuestions,JSON.stringify(a.customQuestions)),T(C(w(a.customQuestions,t),t))}catch{let e=[];try{e=C(w(JSON.parse(localStorage.getItem(n.customQuestions)||`{}`),t),t)}catch{e=C([],t)}T(e)}finally{i||x(!1)}})(),()=>{i=!0}},[t,s]);let R=String(t)===`methods`,z=String(t)===`general-maths`,B=String(t)===`specialist-maths`,V=(0,k.useMemo)(()=>j?[]:R?se():z?oe():B?ce():[`all`,...ze(S.map(e=>e.topic??`General`))],[S,j,R,z,B]),H=(0,k.useMemo)(()=>t?j?$({subjectId:t,subject:y,topic:P,englishSection:I}):!P||P===`all`?null:$({subjectId:t,subject:y,topic:P,englishSection:I}):null,[t,y,P,I,j]);(0,k.useEffect)(()=>{j||V.length&&!V.includes(P)&&F(`all`)},[V,P,j]);let U=()=>{if(t){if(j){o(`/quiz/english?section=${encodeURIComponent(I)}`);return}o(`/quiz/${t}${P&&P!==`all`?`?topic=${encodeURIComponent(P)}`:``}`)}};return(0,A.jsx)(l,{title:y?`${y.name} Practice`:`Practice`,subtitle:`Choose your focus, then start questions.`,edgeToEdgeHeader:!0,edgeToEdgeMain:!0,children:(0,A.jsxs)(`div`,{className:`mx-auto w-full max-w-6xl space-y-5 sm:space-y-6`,children:[(0,A.jsxs)(O,{className:`overflow-hidden rounded-2xl border border-slate-200/80 bg-white/95 shadow-[0_1px_2px_rgba(15,23,42,0.04),0_12px_32px_-16px_rgba(15,23,42,0.1)] ring-1 ring-black/[0.03] backdrop-blur-sm`,children:[(0,A.jsx)(`div`,{className:`h-1 bg-gradient-to-r from-brand/90 via-brand-light/80 to-amber/70`,"aria-hidden":!0}),(0,A.jsxs)(D,{className:`flex flex-col gap-4 p-4 sm:p-5 lg:flex-row lg:items-center lg:justify-between`,children:[(0,A.jsxs)(`div`,{className:`min-w-0`,children:[(0,A.jsxs)(`div`,{className:`flex flex-wrap items-center gap-2`,children:[(0,A.jsx)(`p`,{className:`font-display text-lg font-semibold tracking-tight text-slate-900 sm:text-xl`,children:`Practice setup`}),(0,A.jsxs)(ue,{variant:`secondary`,className:`gap-1 border border-brand/15 bg-brand/8 text-brand-deep`,children:[(0,A.jsx)(ae,{className:`size-3.5`}),`Focus mode`]})]}),(0,A.jsx)(`p`,{className:`mt-1 text-sm leading-relaxed text-slate-500`,children:`Pick a topic / section, then start questions.`})]}),(0,A.jsxs)(`div`,{className:`flex flex-col gap-2 sm:flex-row sm:items-end sm:gap-2 lg:gap-3 lg:justify-end`,children:[b?(0,A.jsxs)(`div`,{className:`flex items-center gap-2 rounded-xl border border-slate-200/80 bg-slate-50/80 px-4 py-3 text-sm text-slate-500`,children:[(0,A.jsx)(h,{className:`size-4 animate-spin`}),`Loading…`]}):j?(0,A.jsxs)(`div`,{className:`min-w-[260px] space-y-2`,children:[(0,A.jsx)(`p`,{className:`text-[0.6875rem] font-semibold uppercase tracking-[0.12em] text-slate-500`,children:`English section`}),(0,A.jsxs)(m,{value:I,onValueChange:e=>L(e??`A`),children:[(0,A.jsx)(d,{className:`h-11 rounded-xl border-slate-200/90 bg-white text-slate-900 shadow-sm ring-1 ring-black/[0.03]`,children:(0,A.jsx)(u,{placeholder:`Choose section`})}),(0,A.jsxs)(f,{alignItemWithTrigger:!1,children:[(0,A.jsx)(p,{value:`A`,children:`Section A — Text response`}),(0,A.jsx)(p,{value:`B`,children:`Section B — Creative`}),(0,A.jsx)(p,{value:`C`,children:`Section C — Writing`})]})]})]}):(0,A.jsxs)(`div`,{className:`min-w-[260px] space-y-2`,children:[(0,A.jsx)(`p`,{className:`text-[0.6875rem] font-semibold uppercase tracking-[0.12em] text-slate-500`,children:`Topic`}),(0,A.jsxs)(m,{value:P,onValueChange:e=>F(e??`all`),children:[(0,A.jsx)(d,{className:`h-11 rounded-xl border-slate-200/90 bg-white text-slate-900 shadow-sm ring-1 ring-black/[0.03]`,children:(0,A.jsx)(u,{placeholder:`Choose topic`})}),(0,A.jsx)(f,{alignItemWithTrigger:!1,className:`max-h-72`,children:V.map(e=>(0,A.jsx)(p,{value:e,children:e===`all`?`All topics`:e},e))})]})]}),(0,A.jsxs)(te,{onClick:U,className:`h-11 gap-2 rounded-xl bg-brand text-white shadow-sm shadow-brand/25 hover:bg-brand-dark`,children:[(0,A.jsx)(ie,{className:`size-4`}),`Questions`,(0,A.jsx)(g,{className:`size-4`})]})]})]})]}),(0,A.jsxs)(O,{className:`overflow-hidden rounded-2xl border border-slate-200/80 bg-white/95 shadow-[0_1px_2px_rgba(15,23,42,0.04),0_12px_32px_-16px_rgba(15,23,42,0.1)] ring-1 ring-black/[0.03] backdrop-blur-sm`,children:[(0,A.jsx)(`div`,{className:`h-1 bg-gradient-to-r from-brand/90 via-brand-light/80 to-amber/70`,"aria-hidden":!0}),(0,A.jsxs)(E,{className:`space-y-2 px-5 pb-1 pt-5 sm:px-7 sm:pt-6`,children:[(0,A.jsx)(le,{className:`font-display text-xl font-semibold tracking-tight text-slate-900 sm:text-2xl`,children:`Study overview`}),(0,A.jsx)(`p`,{className:`text-sm leading-relaxed text-slate-500 sm:text-[0.9375rem]`,children:j?`Section summary for English practice.`:`Reference notes for the topic you select.`})]}),(0,A.jsx)(D,{className:`px-3 pb-6 pt-1 sm:px-5 sm:pb-8`,children:H?(0,A.jsx)(pe,{markdown:H}):(0,A.jsx)(`div`,{className:`rounded-2xl border border-dashed border-slate-200/90 bg-slate-50/60 p-8 text-center`,children:(0,A.jsx)(`p`,{className:`text-sm font-medium text-slate-500`,children:`Select topic`})})})]})]})})}export{Be as default};