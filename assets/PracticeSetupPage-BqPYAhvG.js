import{Jt as e,Vt as t,Wt as n,Xt as r,Yt as i,an as a,cn as o,dn as s,in as c,l,rn as ee,t as te}from"./button-COaERE72.js";import{n as ne}from"./AuthContext-BynRDUOq.js";import{t as u}from"./AppShell-CSEEOh4j.js";import{a as d,i as f,n as p,r as m,t as h}from"./select-YIG9OO6f.js";import{t as re}from"./loader-circle-CmiLeCMn.js";import{o as ie,r as ae,s as oe}from"./index-B3RAB5HW.js";import{C as g,S as _,T as v,_ as y,a as b,b as x,n as S,v as C,w as se,x as ce,y as w}from"./practiceQuestions-BqqIlI6D.js";import{t as T}from"./RichQuestionContent-DtYVWFpd.js";import{a as le,n as E,o as ue,t as D}from"./card-CLoV5BLx.js";import{t as O}from"./badge-Cclum-r7.js";import{n as de,t as k}from"./subjects-r4ToKKGd.js";var A=s(o(),1),j=t();function fe({markdown:e,className:t}){return(0,j.jsxs)(`div`,{className:l(`curriculum-overview relative overflow-hidden rounded-2xl`,`border border-slate-200/80 bg-gradient-to-b from-white via-white to-slate-50/60`,`px-5 py-7 shadow-[0_1px_2px_rgba(15,23,42,0.04),0_16px_48px_-20px_rgba(15,23,42,0.12)]`,`ring-1 ring-black/[0.04] sm:rounded-3xl sm:px-8 sm:py-9`,`text-slate-800 antialiased`,`[&_.katex-error]:hidden`,`[&_a]:font-medium [&_a]:text-brand-deep [&_a]:underline [&_a]:decoration-brand/45 [&_a]:decoration-1 [&_a]:underline-offset-[3px] [&_a]:transition-colors hover:[&_a]:text-brand hover:[&_a]:decoration-brand`,t),children:[(0,j.jsx)(`div`,{className:`pointer-events-none absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-brand/35 to-transparent`,"aria-hidden":!0}),(0,j.jsx)(T,{text:e,preferMarkdown:!0,overviewMode:!0})]})}var M=`### Types of data
...
${F}`)};function B(e){let t=String(e??``).trim();if(!t)return null;let n=v(t);if(Object.prototype.hasOwnProperty.call(z,n))return z[n];let r=I(n),i=L[r]??L[I(t)];if(i)return z[i]??null;for(let e of g)if(I(e)===r||I(e)===I(t))return z[e];return null}var V=`A function takes an input $x$ and gives exactly one output $y$: $y = f(x)$.
...
${n}`}var J={"Functions and transformations":q(`## Functions and transformations`,`Functions, relations and graphs`,V),"Polynomial, power and rational functions":q(`## Polynomial, power and rational functions`,`Functions, relations and graphs`,H),"Exponential and logarithmic functions":q(`## Exponential and logarithmic functions`,`Functions, relations and graphs`,U),"Circular functions":q(`## Circular functions`,`Functions, relations and graphs`,W),"Algebra and equations":q(`## Algebra and equations`,`Algebra`,pe),"Differential calculus":q(`## Differential calculus`,`Calculus`,me),"Applications of differentiation":q(`## Applications of differentiation`,`Calculus`,he),"Integral calculus":q(`## Integral calculus`,`Calculus`,ge),"Applications of integration":q(`## Applications of integration`,`Calculus`,_e),"Discrete random variables":q(`## Discrete random variables`,`Probability and statistics`,ve),"Continuous random variables":q(`## Continuous random variables`,`Probability and statistics`,ye),"The normal distribution":q(`## The normal distribution`,`Probability and statistics`,be),"Sampling and sample proportions":q(`## Sampling and sample proportions`,`Probability and statistics`,xe),"Confidence intervals for proportions":q(`## Confidence intervals for proportions`,`Probability and statistics`,Se)};function Ce(e){let t=String(e??``).trim();if(!t)return null;let n=_(t);if(Object.prototype.hasOwnProperty.call(J,n))return J[n];let r=G(n),i=K[r]??K[G(t)];if(i)return J[i]??null;for(let e of x)if(G(e)===r||G(e)===G(t))return J[e];return null}var we=`### Logic and statements
...
${Fe}`)};function Ie(e){let t=String(e??``).trim();if(!t)return null;let n=w(t);if(Object.prototype.hasOwnProperty.call(Q,n))return Q[n];let r=Y(n),i=X[r]??X[Y(t)];if(i)return Q[i]??null;for(let e of y)if(Y(e)===r||Y(e)===Y(t))return Q[e];return null}function Le(e){return/math|methods|specialist|further/i.test(e)}function Re(e){return e===`A`?`### Section A — Analytical response to a text
...
**Subject:** General Mathematics`:e.subjectId===`specialist-maths`?Ie(n)||`### ${n}
...
**Subject:** Specialist Mathematics`:Le(t)?`### ${n}
...
- Not linking evidence back to the question wording`}function ze(e){return Array.from(new Set(e.map(e=>e.trim()).filter(Boolean))).sort((e,t)=>e.localeCompare(t))}function Be(){let{subjectId:t}=c(),o=ee(),{user:s}=ne(),l=r(s),[g]=a();(0,A.useEffect)(()=>{String(t)===`demo`&&!l&&o(`/dashboard`,{replace:!0})},[t,l,o]);let _=(0,A.useMemo)(()=>l?de({isAdmin:l}):k,[l]),v=(0,A.useMemo)(()=>_.find(e=>String(e.id)===String(t)),[_,t]),[y,x]=(0,A.useState)(!0),[w,T]=(0,A.useState)([]),M=String(t)===`english`,N=String(g.get(`topic`)??`all`),P=String(g.get(`section`)??`A`).toUpperCase()||`A`,[F,I]=(0,A.useState)(N||`all`),[L,R]=(0,A.useState)(P===`B`||P===`C`?P:`A`);(0,A.useEffect)(()=>{if(!t)return;let r=!1;return(async()=>{try{if(x(!0),!s){T(b([],t));return}let a=await n(e.bootstrap);if(r)return;a.customQuestions&&localStorage.setItem(i.customQuestions,JSON.stringify(a.customQuestions)),T(b(S(a.customQuestions,t),t))}catch{let e=[];try{e=b(S(JSON.parse(localStorage.getItem(i.customQuestions)||`{}`),t),t)}catch{e=b([],t)}T(e)}finally{r||x(!1)}})(),()=>{r=!0}},[t,s]);let z=String(t)===`methods`,B=String(t)===`general-maths`,V=String(t)===`specialist-maths`,H=(0,A.useMemo)(()=>M?[]:z?ce():B?se():V?C():[`all`,...ze(w.map(e=>e.topic??`General`))],[w,M,z,B,V]),U=(0,A.useMemo)(()=>t?M?$({subjectId:t,subject:v,topic:F,englishSection:L}):!F||F===`all`?null:$({subjectId:t,subject:v,topic:F,englishSection:L}):null,[t,v,F,L,M]);(0,A.useEffect)(()=>{M||H.length&&!H.includes(F)&&I(`all`)},[H,F,M]);let W=()=>{if(t){if(M){o(`/quiz/english?section=${encodeURIComponent(L)}`);return}o(`/quiz/${t}${F&&F!==`all`?`?topic=${encodeURIComponent(F)}`:``}`)}};return(0,j.jsx)(u,{title:v?`${v.name} Practice`:`Practice`,subtitle:`Choose your focus, then start questions.`,edgeToEdgeHeader:!0,edgeToEdgeMain:!0,children:(0,j.jsxs)(`div`,{className:`mx-auto w-full max-w-6xl space-y-5 sm:space-y-6`,children:[(0,j.jsxs)(D,{className:`overflow-hidden rounded-2xl border border-slate-200/80 bg-white/95 shadow-[0_1px_2px_rgba(15,23,42,0.04),0_12px_32px_-16px_rgba(15,23,42,0.1)] ring-1 ring-black/[0.03] backdrop-blur-sm`,children:[(0,j.jsx)(`div`,{className:`h-1 bg-gradient-to-r from-brand/90 via-brand-light/80 to-amber/70`,"aria-hidden":!0}),(0,j.jsxs)(E,{className:`flex flex-col gap-4 p-4 sm:p-5 lg:flex-row lg:items-center lg:justify-between`,children:[(0,j.jsxs)(`div`,{className:`min-w-0`,children:[(0,j.jsxs)(`div`,{className:`flex flex-wrap items-center gap-2`,children:[(0,j.jsx)(`p`,{className:`font-display text-lg font-semibold tracking-tight text-slate-900 sm:text-xl`,children:`Practice setup`}),(0,j.jsxs)(O,{variant:`secondary`,className:`gap-1 border border-brand/15 bg-brand/8 text-brand-deep`,children:[(0,j.jsx)(ae,{className:`size-3.5`}),`Focus mode`]})]}),(0,j.jsx)(`p`,{className:`mt-1 text-sm leading-relaxed text-slate-500`,children:`Pick a topic / section, then start questions.`})]}),(0,j.jsxs)(`div`,{className:`flex flex-col gap-2 sm:flex-row sm:items-end sm:gap-2 lg:gap-3 lg:justify-end`,children:[y?(0,j.jsxs)(`div`,{className:`flex items-center gap-2 rounded-xl border border-slate-200/80 bg-slate-50/80 px-4 py-3 text-sm text-slate-500`,children:[(0,j.jsx)(re,{className:`size-4 animate-spin`}),`Loading…`]}):M?(0,j.jsxs)(`div`,{className:`min-w-[260px] space-y-2`,children:[(0,j.jsx)(`p`,{className:`text-[0.6875rem] font-semibold uppercase tracking-[0.12em] text-slate-500`,children:`English section`}),(0,j.jsxs)(h,{value:L,onValueChange:e=>R(e??`A`),children:[(0,j.jsx)(f,{className:`h-11 rounded-xl border-slate-200/90 bg-white text-slate-900 shadow-sm ring-1 ring-black/[0.03]`,children:(0,j.jsx)(d,{placeholder:`Choose section`})}),(0,j.jsxs)(p,{alignItemWithTrigger:!1,children:[(0,j.jsx)(m,{value:`A`,children:`Section A — Text response`}),(0,j.jsx)(m,{value:`B`,children:`Section B — Creative`}),(0,j.jsx)(m,{value:`C`,children:`Section C — Writing`})]})]})]}):(0,j.jsxs)(`div`,{className:`min-w-[260px] space-y-2`,children:[(0,j.jsx)(`p`,{className:`text-[0.6875rem] font-semibold uppercase tracking-[0.12em] text-slate-500`,children:`Topic`}),(0,j.jsxs)(h,{value:F,onValueChange:e=>I(e??`all`),children:[(0,j.jsx)(f,{className:`h-11 rounded-xl border-slate-200/90 bg-white text-slate-900 shadow-sm ring-1 ring-black/[0.03]`,children:(0,j.jsx)(d,{placeholder:`Choose topic`})}),(0,j.jsx)(p,{alignItemWithTrigger:!1,className:`max-h-72`,children:H.map(e=>(0,j.jsx)(m,{value:e,children:e===`all`?`All topics`:e},e))})]})]}),(0,j.jsxs)(te,{onClick:W,className:`h-11 gap-2 rounded-xl bg-brand text-white shadow-sm shadow-brand/25 hover:bg-brand-dark`,children:[(0,j.jsx)(ie,{className:`size-4`}),`Questions`,(0,j.jsx)(oe,{className:`size-4`})]})]})]})]}),(0,j.jsxs)(D,{className:`overflow-hidden rounded-2xl border border-slate-200/80 bg-white/95 shadow-[0_1px_2px_rgba(15,23,42,0.04),0_12px_32px_-16px_rgba(15,23,42,0.1)] ring-1 ring-black/[0.03] backdrop-blur-sm`,children:[(0,j.jsx)(`div`,{className:`h-1 bg-gradient-to-r from-brand/90 via-brand-light/80 to-amber/70`,"aria-hidden":!0}),(0,j.jsxs)(le,{className:`space-y-2 px-5 pb-1 pt-5 sm:px-7 sm:pt-6`,children:[(0,j.jsx)(ue,{className:`font-display text-xl font-semibold tracking-tight text-slate-900 sm:text-2xl`,children:`Study overview`}),(0,j.jsx)(`p`,{className:`text-sm leading-relaxed text-slate-500 sm:text-[0.9375rem]`,children:M?`Section summary for English practice.`:`Reference notes for the topic you select.`})]}),(0,j.jsx)(E,{className:`px-3 pb-6 pt-1 sm:px-5 sm:pb-8`,children:U?(0,j.jsx)(fe,{markdown:U}):(0,j.jsx)(`div`,{className:`rounded-2xl border border-dashed border-slate-200/90 bg-slate-50/60 p-8 text-center`,children:(0,j.jsx)(`p`,{className:`text-sm font-medium text-slate-500`,children:`Select topic`})})})]})]})})}export{Be as default};