<<<<<<<< HEAD:assets/PracticeSetupPage-B_WzPW1W.js
import{Gt as e,Ht as t,Qt as n,Xt as r,Zt as i,an as a,fn as o,ln as s,n as ee,on as te,sn as ne,u as c}from"./NodentWordmark-CO5y-ebc.js";import{ut as re}from"./composite-p428621u.js";import{t as ie}from"./AppShell-ByVvX1MN.js";import{t as ae}from"./book-open-BSuMh-l8.js";import{a as l,i as u,n as d,r as f,t as p}from"./select-Cla4-v6Z.js";import{t as oe}from"./loader-circle-BbAB0nwi.js";import{o as m}from"./index-Bom5TRO7.js";import{B as h,F as g,H as se,I as ce,L as _,R as v,U as y,V as b,o as x,r as S,z as C}from"./practiceQuestions-CZ2Qgslt.js";import{n as w,t as T}from"./card-BWARm9sO.js";import{n as le,t as ue}from"./subjects-J9LuY-j1.js";import{r as E}from"./QuestionStimulus-DbkOpIGm.js";var D=o(s(),1),O=t();function k({markdown:e,className:t}){return(0,O.jsx)(`div`,{className:c(`curriculum-overview relative overflow-hidden rounded-2xl`,`border border-black/10 border-l-4 border-l-brand-light/70 bg-[#f3f4f6]/50`,`px-5 py-7 sm:rounded-3xl sm:px-8 sm:py-9`,`text-[#0b0f19] antialiased`,`[&_.katex-error]:hidden`,`[&_a]:font-medium [&_a]:text-brand-deep [&_a]:underline [&_a]:decoration-brand/45 [&_a]:decoration-1 [&_a]:underline-offset-[3px] [&_a]:transition-colors hover:[&_a]:text-brand hover:[&_a]:decoration-brand`,t),children:(0,O.jsx)(E,{text:e,preferMarkdown:!0,overviewMode:!0})})}var A=`### Types of data
========
import{$ as e,Q as t,W as n,Z as r,it as i,t as a,tt as o}from"./button-DZAIKKfj.js";import{a as ee,f as te,i as ne,m as re,p as ie}from"./api-B6HcDVRd.js";import{dt as ae}from"./composite-P1AL7iI7.js";import{t as oe}from"./AppShell-CE_-92da.js";import{n as s}from"./utils-D9ryjJki.js";import{t as c}from"./book-open-BYoc-5Pz.js";import{a as l,i as u,n as d,r as f,t as p}from"./select-C_be_h6J.js";import{t as se}from"./file-text-DO2nURI9.js";import{s as m,u as h}from"./index-DXDaKRDl.js";import{B as g,G as _,H as v,K as ce,U as le,V as y,W as b,o as x,q as S,r as ue,z as C}from"./practiceQuestions-3lxOq6Hs.js";import{n as w}from"./questionBankCache-Cd8LjY7O.js";import{n as T,t as E}from"./card-IRMwW_9p.js";import{n as D,t as O}from"./subjects-B5ghlaQk.js";import{r as k}from"./QuestionStimulus-D4mIYqhN.js";var A=i(o(),1),j=n();function de({markdown:e,className:t}){return(0,j.jsx)(`div`,{className:s(`curriculum-overview relative overflow-hidden rounded-2xl`,`border border-black/10 border-l-4 border-l-brand-light/70 bg-[#f3f4f6]/50`,`px-5 py-7 sm:rounded-3xl sm:px-8 sm:py-9`,`text-[#0b0f19] antialiased`,`[&_.katex-error]:hidden`,`[&_a]:font-medium [&_a]:text-brand-deep [&_a]:underline [&_a]:decoration-brand/45 [&_a]:decoration-1 [&_a]:underline-offset-[3px] [&_a]:transition-colors hover:[&_a]:text-brand hover:[&_a]:decoration-brand`,t),children:(0,j.jsx)(k,{text:e,preferMarkdown:!0,overviewMode:!0})})}var M=`### Types of data
>>>>>>>> feature/class-exams:assets/PracticeSetupPage-C3TFyJqI.js
...
${F}`)};function B(e){let t=String(e??``).trim();if(!t)return null;let n=S(t);if(Object.prototype.hasOwnProperty.call(z,n))return z[n];let r=I(n),i=L[r]??L[I(t)];if(i)return z[i]??null;for(let e of _)if(I(e)===r||I(e)===I(t))return z[e];return null}var V=`A function takes an input $x$ and gives exactly one output $y$: $y = f(x)$.
...
`,me=`Calculus studies **change** (differentiation) and **accumulation** (integration).
...
`,_e=`### Definite integrals and area
...
${n}`}var q={"Functions and transformations":K(`## Functions and transformations`,`Functions, relations and graphs`,V),"Polynomial, power and rational functions":K(`## Polynomial, power and rational functions`,`Functions, relations and graphs`,H),"Exponential and logarithmic functions":K(`## Exponential and logarithmic functions`,`Functions, relations and graphs`,U),"Circular functions":K(`## Circular functions`,`Functions, relations and graphs`,fe),"Algebra and equations":K(`## Algebra and equations`,`Algebra`,pe),"Differential calculus":K(`## Differential calculus`,`Calculus`,me),"Applications of differentiation":K(`## Applications of differentiation`,`Calculus`,he),"Integral calculus":K(`## Integral calculus`,`Calculus`,ge),"Applications of integration":K(`## Applications of integration`,`Calculus`,_e),"Discrete random variables":K(`## Discrete random variables`,`Probability and statistics`,ve),"Continuous random variables":K(`## Continuous random variables`,`Probability and statistics`,ye),"The normal distribution":K(`## The normal distribution`,`Probability and statistics`,be),"Sampling and sample proportions":K(`## Sampling and sample proportions`,`Probability and statistics`,xe),"Confidence intervals for proportions":K(`## Confidence intervals for proportions`,`Probability and statistics`,Se)};function Ce(e){let t=String(e??``).trim();if(!t)return null;let n=b(t);if(Object.prototype.hasOwnProperty.call(q,n))return q[n];let r=W(n),i=G[r]??G[W(t)];if(i)return q[i]??null;for(let e of v)if(W(e)===r||W(e)===W(t))return q[e];return null}var we=`### Logic and statements
...
`,J=e=>String(e??``).trim().toLowerCase().replace(/\s+/g,` `),Y={"proof and number":`Logic and proof`,"graph theory":`Logic and proof`,"logic and algorithms":`Logic and proof`,"complex numbers":`Complex numbers and algebra`,calculus:`Differential calculus`,statistics:`Random variables and sampling`,probability:`Random variables and sampling`,"probability and statistics: random variables and sampling":`Random variables and sampling`};function X(e,t,n){return`${e}

**Area:** ${t}

---

${n}`}var Z={"Logic and proof":X(`## Logic and proof`,`Discrete mathematics`,`Making mathematical arguments precise — statements, proof styles, and induction.

${we}`),"Complex numbers and algebra":X(`## Complex numbers and algebra`,`Algebra, number and structure`,`Complex arithmetic, polar form, De Moivre’s theorem, and roots.

${Ee}`),"Functions, relations and graphs":X(`## Functions, relations and graphs`,`Functions, relations and graphs`,`Rational functions, partial fractions, parametric and polar graphs.

${Te}`),"Differential calculus":X(`## Differential calculus`,`Calculus`,`Advanced differentiation — rules, implicit differentiation, and related rates.

${De}`),"Integral calculus":X(`## Integral calculus`,`Calculus`,`Integration techniques and when to use them.

${Oe}`),"Differential equations":X(`## Differential equations`,`Calculus`,`Equations involving derivatives — modelling and separable solutions.

${ke}`),Kinematics:X(`## Kinematics`,`Calculus / mechanics`,`Position, velocity and acceleration linked by calculus.

${Ae}`),"Vectors in two and three dimensions":X(`## Vectors in two and three dimensions`,`Space and measurement`,`Vector operations, dot product, projection, and cross product.

${je}`),"Lines and planes in 3D":X(`## Lines and planes in 3D`,`Space and measurement`,`Lines and planes in 3D, normals, and distances.

${Me}`),"Vector calculus":X(`## Vector calculus`,`Space and measurement`,`Vector functions of time and parametric motion.

${Ne}`),"Random variables and sampling":X(`## Random variables and sampling`,`Data analysis, probability and statistics`,`Random variables, binomial and normal models, and sample means.

${Pe}`),"Confidence intervals":X(`## Confidence intervals`,`Data analysis, probability and statistics`,`Estimate a population mean — plus exam strategy and key formulas.

${Fe}`)};function Q(e){let t=String(e??``).trim();if(!t)return null;let n=y(t);if(Object.prototype.hasOwnProperty.call(Z,n))return Z[n];let r=J(n),i=Y[r]??Y[J(t)];if(i)return Z[i]??null;for(let e of C)if(J(e)===r||J(e)===J(t))return Z[e];return null}function Ie(e){return/math|methods|specialist|further/i.test(e)}function Le(e){return e===`A`?`### Section A — Analytical response to a text
...
By describing the proposal as a “smarter investment”, the writer positions the audience to view the change as practical and responsible, strengthening support for their overall contention.`}function $(e){let t=e.subject?.name??e.subjectId;if(e.subjectId===`english`)return Le(e.englishSection??`A`);let n=(e.topic??`all`).trim();return!n||n===`all`?`### Your plan
...
**Subject:** Mathematical Methods`:e.subjectId===`general-maths`||e.subjectId===`demo`?B(n)||`### ${n}
...
**Subject:** General Mathematics`:e.subjectId===`specialist-maths`?Q(n)||`### ${n}
...
**Subject:** Specialist Mathematics`:Ie(t)?`### ${n}
...
- Not linking evidence back to the question wording`}function Re(e){return Array.from(new Set(e.map(e=>e.trim()).filter(Boolean))).sort((e,t)=>e.localeCompare(t))}function ze(){let{subjectId:n}=t(),i=r(),{user:o}=ae(),s=re(o),[_]=e();(0,A.useEffect)(()=>{String(n)===`demo`&&!s&&i(`/dashboard`,{replace:!0})},[n,s,i]);let v=(0,A.useMemo)(()=>s?D({isAdmin:s}):O,[s]),y=(0,A.useMemo)(()=>v.find(e=>String(e.id)===String(n)),[v,n]),[b,S]=(0,A.useState)(!0),[C,k]=(0,A.useState)([]),M=String(n)===`english`,N=String(_.get(`topic`)??`all`),P=String(_.get(`section`)??`A`).toUpperCase()||`A`,[F,I]=(0,A.useState)(N||`all`),[L,R]=(0,A.useState)(P===`B`||P===`C`?P:`A`);(0,A.useEffect)(()=>{if(!n)return;let e=!1,t=w(n);if(t.length>0)k(t),S(!1);else if(o)S(!0);else{k(x([],n)),S(!1);return}if(o)return(async()=>{try{let t=await ee(te.bootstrap,{timeoutMs:ne});if(e)return;t.customQuestions&&localStorage.setItem(ie.customQuestions,JSON.stringify(t.customQuestions)),k(x(ue(t.customQuestions,n),n))}catch{if(e)return;k(w(n))}finally{e||S(!1)}})(),()=>{e=!0}},[n,o]);let z=String(n)===`methods`,B=String(n)===`general-maths`||String(n)===`demo`,V=String(n)===`specialist-maths`,H=(0,A.useMemo)(()=>M?[]:z?le():B?ce():V?g():[`all`,...Re(C.map(e=>e.topic??`General`))],[C,M,z,B,V]),U=(0,A.useMemo)(()=>n?M?$({subjectId:n,subject:y,topic:F,englishSection:L}):!F||F===`all`?null:$({subjectId:n,subject:y,topic:F,englishSection:L}):null,[n,y,F,L,M]);return(0,A.useEffect)(()=>{M||H.length&&!H.includes(F)&&I(`all`)},[H,F,M]),(0,j.jsx)(oe,{title:y?`${y.name} Practice`:`Practice`,subtitle:`Choose your focus, then start questions.`,edgeToEdgeHeader:!0,edgeToEdgeMain:!0,children:(0,j.jsxs)(`div`,{className:`mx-auto w-full max-w-6xl space-y-5 sm:space-y-6`,children:[(0,j.jsxs)(E,{className:`practice-card`,children:[(0,j.jsx)(`div`,{className:`practice-card-header`,children:(0,j.jsx)(`p`,{className:`practice-card-header-title`,children:`Practice setup`})}),(0,j.jsxs)(T,{className:`flex flex-col gap-4 bg-[#f3f4f6]/30 px-4 py-5 sm:px-7 sm:py-6 lg:flex-row lg:items-center lg:justify-between lg:gap-6`,children:[(0,j.jsxs)(`div`,{className:`min-w-0`,children:[(0,j.jsx)(`p`,{className:`font-display text-lg font-semibold tracking-tight text-[#0b0f19] sm:text-xl`,children:y?.name??`Subject`}),(0,j.jsx)(`p`,{className:`mt-1 text-sm leading-relaxed text-muted-foreground`,children:`Pick a topic / section, then start questions.`})]}),(0,j.jsxs)(`div`,{className:`flex w-full flex-col gap-3 sm:flex-row sm:items-end sm:justify-end lg:gap-3`,children:[b?(0,j.jsxs)(`div`,{className:`flex items-center gap-2 rounded-xl border border-black/8 bg-[#f3f4f6] px-4 py-3 text-sm text-muted-foreground`,children:[(0,j.jsx)(m,{className:`size-4 animate-spin`}),`Loading…`]}):M?(0,j.jsxs)(`div`,{className:`w-full min-w-0 space-y-2 sm:min-w-[260px]`,children:[(0,j.jsx)(`p`,{className:`text-[0.6875rem] font-semibold uppercase tracking-[0.12em] text-muted-foreground`,children:`English section`}),(0,j.jsxs)(p,{value:L,onValueChange:e=>R(e??`A`),children:[(0,j.jsx)(u,{className:`h-11 rounded-xl border-brand-light/50 bg-brand-light/50 text-[#0b0f19]`,children:(0,j.jsx)(l,{placeholder:`Choose section`})}),(0,j.jsxs)(d,{alignItemWithTrigger:!1,children:[(0,j.jsx)(f,{value:`A`,children:`Section A — Text response`}),(0,j.jsx)(f,{value:`B`,children:`Section B — Creative`}),(0,j.jsx)(f,{value:`C`,children:`Section C — Writing`})]})]})]}):(0,j.jsxs)(`div`,{className:`w-full min-w-0 space-y-2 sm:min-w-[260px]`,children:[(0,j.jsx)(`p`,{className:`text-[0.6875rem] font-semibold uppercase tracking-[0.12em] text-muted-foreground`,children:`Topic`}),(0,j.jsxs)(p,{value:F,onValueChange:e=>I(e??`all`),children:[(0,j.jsx)(u,{className:`h-11 rounded-xl border-brand-light/50 bg-brand-light/50 text-[#0b0f19]`,children:(0,j.jsx)(l,{placeholder:`Choose topic`})}),(0,j.jsx)(d,{alignItemWithTrigger:!1,className:`max-h-72`,children:H.map(e=>(0,j.jsx)(f,{value:e,children:e===`all`?`All topics`:e},e))})]})]}),(0,j.jsxs)(`div`,{className:`flex w-full flex-col gap-2 sm:w-auto sm:flex-row`,children:[(0,j.jsxs)(a,{type:`button`,variant:`outline`,onClick:()=>i(`/practice/${n}/exams`),className:`h-11 w-full gap-2 rounded-xl sm:w-auto`,children:[(0,j.jsx)(se,{className:`size-4`}),`Exams`,(0,j.jsx)(h,{className:`size-4`})]}),(0,j.jsxs)(a,{variant:`accent`,onClick:()=>{if(n){if(M){i(`/quiz/english?section=${encodeURIComponent(L)}`);return}i(`/quiz/${n}${F&&F!==`all`?`?topic=${encodeURIComponent(F)}`:``}`)}},className:`h-11 w-full gap-2 rounded-xl sm:w-auto`,children:[(0,j.jsx)(c,{className:`size-4`}),`Questions`,(0,j.jsx)(h,{className:`size-4`})]})]})]})]})]}),(0,j.jsxs)(E,{className:`practice-card`,children:[(0,j.jsx)(`div`,{className:`practice-card-header`,children:(0,j.jsx)(`p`,{className:`practice-card-header-title`,children:`Study overview`})}),(0,j.jsx)(T,{className:`px-4 py-5 sm:px-7 sm:py-6`,children:U?(0,j.jsx)(de,{markdown:U}):(0,j.jsx)(`div`,{className:`rounded-2xl border border-dashed border-black/15 bg-[#0b0f19]/[0.03] p-8 text-center`,children:(0,j.jsx)(`p`,{className:`text-sm font-medium text-muted-foreground`,children:`Choose a topic above to load overview notes.`})})})]})]})})}export{ze as default};