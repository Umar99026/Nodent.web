import{$ as e,Q as t,W as n,Z as r,it as i,t as a,tt as o}from"./button-2jHUfSWQ.js";import{f as s,h as ee,i as te,m as ne,p as re,r as ie}from"./api-DwW6HsVc.js";import{dt as ae}from"./composite-D9qrB8Cm.js";import{t as oe}from"./AppShell-Ck84IEaY.js";import{n as c}from"./utils-CKKkuKf7.js";import{t as l}from"./book-open-DOzmAWMe.js";import{a as u,i as d,n as f,r as p,t as m}from"./select-B1RoqKHU.js";import{t as se}from"./file-text-D7uamfBy.js";import{s as ce,u as h}from"./index-DzNU-pWl.js";import{B as g,H as le,J as _,K as v,U as y,W as b,Y as x,Z as S,o as C,q as w,r as ue}from"./practiceQuestions-ClJTgTko.js";import{n as T}from"./questionBankCache-6DINdOYC.js";import{n as E,t as D}from"./card-BJX6qHda.js";import{n as de,t as fe}from"./subjects-N_SZ4P0p.js";import{t as O}from"./RichQuestionContent-CDySp8WT.js";var k=i(o(),1),A=n();function pe({markdown:e,className:t}){return(0,A.jsx)(`div`,{className:c(`curriculum-overview relative overflow-hidden rounded-2xl`,`border border-black/10 border-l-4 border-l-brand-light/70 bg-[#f3f4f6]/50`,`px-5 py-7 sm:rounded-3xl sm:px-8 sm:py-9`,`text-[#0b0f19] antialiased`,`[&_.katex-error]:hidden`,`[&_a]:font-medium [&_a]:text-brand-deep [&_a]:underline [&_a]:decoration-brand/45 [&_a]:decoration-1 [&_a]:underline-offset-[3px] [&_a]:transition-colors hover:[&_a]:text-brand hover:[&_a]:decoration-brand`,t),children:(0,A.jsx)(O,{text:e,preferMarkdown:!0,overviewMode:!0})})}var j=`### Types of data
...
${P}`)};function z(e){let t=String(e??``).trim();if(!t)return null;let n=S(t);if(Object.prototype.hasOwnProperty.call(R,n))return R[n];let r=F(n),i=I[r]??I[F(t)];if(i)return R[i]??null;for(let e of _)if(F(e)===r||F(e)===F(t))return R[e];return null}var B=`A function takes an input $x$ and gives exactly one output $y$: $y = f(x)$.
...
${n}`}var J={"Functions and transformations":q(`## Functions and transformations`,`Functions, relations and graphs`,B),"Polynomial, power and rational functions":q(`## Polynomial, power and rational functions`,`Functions, relations and graphs`,V),"Exponential and logarithmic functions":q(`## Exponential and logarithmic functions`,`Functions, relations and graphs`,H),"Circular functions":q(`## Circular functions`,`Functions, relations and graphs`,U),"Algebra and equations":q(`## Algebra and equations`,`Algebra`,me),"Differential calculus":q(`## Differential calculus`,`Calculus`,he),"Applications of differentiation":q(`## Applications of differentiation`,`Calculus`,ge),"Integral calculus":q(`## Integral calculus`,`Calculus`,_e),"Applications of integration":q(`## Applications of integration`,`Calculus`,W),"Discrete random variables":q(`## Discrete random variables`,`Probability and statistics`,ve),"Continuous random variables":q(`## Continuous random variables`,`Probability and statistics`,ye),"The normal distribution":q(`## The normal distribution`,`Probability and statistics`,be),"Sampling and sample proportions":q(`## Sampling and sample proportions`,`Probability and statistics`,xe),"Confidence intervals for proportions":q(`## Confidence intervals for proportions`,`Probability and statistics`,Se)};function Ce(e){let t=String(e??``).trim();if(!t)return null;let n=w(t);if(Object.prototype.hasOwnProperty.call(J,n))return J[n];let r=G(n),i=K[r]??K[G(t)];if(i)return J[i]??null;for(let e of b)if(G(e)===r||G(e)===G(t))return J[e];return null}var we=`### Logic and statements
...
${Fe}`)};function Ie(e){let t=String(e??``).trim();if(!t)return null;let n=y(t);if(Object.prototype.hasOwnProperty.call(Q,n))return Q[n];let r=Y(n),i=X[r]??X[Y(t)];if(i)return Q[i]??null;for(let e of g)if(Y(e)===r||Y(e)===Y(t))return Q[e];return null}function Le(e){return/math|methods|specialist|further/i.test(e)}function Re(e){return e===`A`?`### Section A — Analytical response to a text
...
- Not linking evidence back to the question wording`}function ze(e){return Array.from(new Set(e.map(e=>e.trim()).filter(Boolean))).sort((e,t)=>e.localeCompare(t))}function Be(){let{subjectId:n}=t(),i=r(),{user:o}=ae(),c=ee(o),g=ne(o),[_]=e();(0,k.useEffect)(()=>{String(n)===`demo`&&!c&&i(`/dashboard`,{replace:!0})},[n,c,i]);let y=(0,k.useMemo)(()=>c?de({isAdmin:c}):fe,[c]),b=(0,k.useMemo)(()=>y.find(e=>String(e.id)===String(n)),[y,n]),[S,w]=(0,k.useState)(!0),[O,j]=(0,k.useState)([]),M=String(n)===`english`,N=String(_.get(`topic`)??`all`),P=String(_.get(`section`)??`A`).toUpperCase()||`A`,[F,I]=(0,k.useState)(N||`all`),[L,R]=(0,k.useState)(P===`B`||P===`C`?P:`A`);(0,k.useEffect)(()=>{if(!n)return;let e=!1,t=T(n);if(t.length>0)j(t),w(!1);else if(o)w(!0);else{j(C([],n)),w(!1);return}if(o)return(async()=>{try{let t=await te(s.bootstrap,{timeoutMs:ie});if(e)return;t.customQuestions&&localStorage.setItem(re.customQuestions,JSON.stringify(t.customQuestions)),j(C(ue(t.customQuestions,n),n))}catch{if(e)return;j(T(n))}finally{e||w(!1)}})(),()=>{e=!0}},[n,o]);let z=String(n)===`methods`,B=String(n)===`general-maths`||String(n)===`demo`,V=String(n)===`specialist-maths`,H=(0,k.useMemo)(()=>M?[]:z?v():B?x():V?le():[`all`,...ze(O.map(e=>e.topic??`General`))],[O,M,z,B,V]),U=(0,k.useMemo)(()=>n?M?$({subjectId:n,subject:b,topic:F,englishSection:L}):!F||F===`all`?null:$({subjectId:n,subject:b,topic:F,englishSection:L}):null,[n,b,F,L,M]);return(0,k.useEffect)(()=>{M||H.length&&!H.includes(F)&&I(`all`)},[H,F,M]),(0,A.jsx)(oe,{title:b?`${b.name} Practice`:`Practice`,subtitle:`Choose your focus, then start questions.`,edgeToEdgeHeader:!0,edgeToEdgeMain:!0,children:(0,A.jsxs)(`div`,{className:`mx-auto w-full max-w-6xl space-y-5 sm:space-y-6`,children:[(0,A.jsxs)(D,{className:`practice-card`,children:[(0,A.jsx)(`div`,{className:`practice-card-header`,children:(0,A.jsx)(`p`,{className:`practice-card-header-title`,children:`Practice setup`})}),(0,A.jsxs)(E,{className:`flex flex-col gap-4 bg-[#f3f4f6]/30 px-4 py-5 sm:px-7 sm:py-6 lg:flex-row lg:items-center lg:justify-between lg:gap-6`,children:[(0,A.jsxs)(`div`,{className:`min-w-0`,children:[(0,A.jsx)(`p`,{className:`font-display text-lg font-semibold tracking-tight text-[#0b0f19] sm:text-xl`,children:b?.name??`Subject`}),(0,A.jsx)(`p`,{className:`mt-1 text-sm leading-relaxed text-muted-foreground`,children:`Pick a topic / section, then start questions.`})]}),(0,A.jsxs)(`div`,{className:`flex w-full flex-col gap-3 sm:flex-row sm:items-end sm:justify-end lg:gap-3`,children:[S?(0,A.jsxs)(`div`,{className:`flex items-center gap-2 rounded-xl border border-black/8 bg-[#f3f4f6] px-4 py-3 text-sm text-muted-foreground`,children:[(0,A.jsx)(ce,{className:`size-4 animate-spin`}),`Loading…`]}):M?(0,A.jsxs)(`div`,{className:`w-full min-w-0 space-y-2 sm:min-w-[260px]`,children:[(0,A.jsx)(`p`,{className:`text-[0.6875rem] font-semibold uppercase tracking-[0.12em] text-muted-foreground`,children:`English section`}),(0,A.jsxs)(m,{value:L,onValueChange:e=>R(e??`A`),children:[(0,A.jsx)(d,{className:`h-11 rounded-xl border-brand-light/50 bg-brand-light/50 text-[#0b0f19]`,children:(0,A.jsx)(u,{placeholder:`Choose section`})}),(0,A.jsxs)(f,{alignItemWithTrigger:!1,children:[(0,A.jsx)(p,{value:`A`,children:`Section A — Text response`}),(0,A.jsx)(p,{value:`B`,children:`Section B — Creative`}),(0,A.jsx)(p,{value:`C`,children:`Section C — Writing`})]})]})]}):(0,A.jsxs)(`div`,{className:`w-full min-w-0 space-y-2 sm:min-w-[260px]`,children:[(0,A.jsx)(`p`,{className:`text-[0.6875rem] font-semibold uppercase tracking-[0.12em] text-muted-foreground`,children:`Topic`}),(0,A.jsxs)(m,{value:F,onValueChange:e=>I(e??`all`),children:[(0,A.jsx)(d,{className:`h-11 rounded-xl border-brand-light/50 bg-brand-light/50 text-[#0b0f19]`,children:(0,A.jsx)(u,{placeholder:`Choose topic`})}),(0,A.jsx)(f,{alignItemWithTrigger:!1,className:`max-h-72`,children:H.map(e=>(0,A.jsx)(p,{value:e,children:e===`all`?`All topics`:e},e))})]})]}),(0,A.jsxs)(`div`,{className:`flex w-full flex-col gap-2 sm:w-auto sm:flex-row`,children:[g?(0,A.jsxs)(a,{type:`button`,variant:`outline`,onClick:()=>i(`/practice/${n}/exams`),className:`h-11 w-full gap-2 rounded-xl sm:w-auto`,children:[(0,A.jsx)(se,{className:`size-4`}),`Exams`,(0,A.jsx)(h,{className:`size-4`})]}):null,(0,A.jsxs)(a,{variant:`accent`,onClick:()=>{if(n){if(M){i(`/quiz/english?section=${encodeURIComponent(L)}`);return}i(`/quiz/${n}${F&&F!==`all`?`?topic=${encodeURIComponent(F)}`:``}`)}},className:`h-11 w-full gap-2 rounded-xl sm:w-auto`,children:[(0,A.jsx)(l,{className:`size-4`}),`Questions`,(0,A.jsx)(h,{className:`size-4`})]})]})]})]})]}),(0,A.jsxs)(D,{className:`practice-card`,children:[(0,A.jsx)(`div`,{className:`practice-card-header`,children:(0,A.jsx)(`p`,{className:`practice-card-header-title`,children:`Study overview`})}),(0,A.jsx)(E,{className:`px-4 py-5 sm:px-7 sm:py-6`,children:U?(0,A.jsx)(pe,{markdown:U}):(0,A.jsx)(`div`,{className:`rounded-2xl border border-dashed border-black/15 bg-[#0b0f19]/[0.03] p-8 text-center`,children:(0,A.jsx)(`p`,{className:`text-sm font-medium text-muted-foreground`,children:`Choose a topic above to load overview notes.`})})})]})]})})}export{Be as default};