...
${N}`)};function R(e){let t=String(e??``).trim();if(!t)return null;let n=y(t);if(Object.prototype.hasOwnProperty.call(L,n))return L[n];let r=P(n),i=F[r]??F[P(t)];if(i)return L[i]??null;for(let e of b)if(P(e)===r||P(e)===P(t))return L[e];return null}var z=`A function takes an input $x$ and gives exactly one output $y$: $y = f(x)$.
...
- Not linking evidence back to the question wording`}function Fe(e){return Array.from(new Set(e.map(e=>e.trim()).filter(Boolean))).sort((e,t)=>e.localeCompare(t))}function Ie(){let{subjectId:t}=te(),o=a(),{user:s}=re(),c=n(s),[h]=ne();(0,D.useEffect)(()=>{String(t)===`demo`&&!c&&o(`/dashboard`,{replace:!0})},[t,c,o]);let g=(0,D.useMemo)(()=>c?le({isAdmin:c}):ue,[c]),_=(0,D.useMemo)(()=>g.find(e=>String(e.id)===String(t)),[g,t]),[v,y]=(0,D.useState)(!0),[b,E]=(0,D.useState)([]),A=String(t)===`english`,j=String(h.get(`topic`)??`all`),M=String(h.get(`section`)??`A`).toUpperCase()||`A`,[N,P]=(0,D.useState)(j||`all`),[F,I]=(0,D.useState)(M===`B`||M===`C`?M:`A`);(0,D.useEffect)(()=>{if(!t)return;let n=!1;return(async()=>{try{if(y(!0),!s){E(x([],t));return}let a=await e(r.bootstrap);if(n)return;a.customQuestions&&localStorage.setItem(i.customQuestions,JSON.stringify(a.customQuestions)),E(x(S(a.customQuestions,t),t))}catch{let e=[];try{e=x(S(JSON.parse(localStorage.getItem(i.customQuestions)||`{}`),t),t)}catch{e=x([],t)}E(e)}finally{n||y(!1)}})(),()=>{n=!0}},[t,s]);let L=String(t)===`methods`,R=String(t)===`general-maths`,z=String(t)===`specialist-maths`,B=(0,D.useMemo)(()=>A?[]:L?C():R?se():z?ce():[`all`,...Fe(b.map(e=>e.topic??`General`))],[b,A,L,R,z]),V=(0,D.useMemo)(()=>t?A?$({subjectId:t,subject:_,topic:N,englishSection:F}):!N||N===`all`?null:$({subjectId:t,subject:_,topic:N,englishSection:F}):null,[t,_,N,F,A]);return(0,D.useEffect)(()=>{A||B.length&&!B.includes(N)&&P(`all`)},[B,N,A]),(0,O.jsx)(ie,{title:_?`${_.name} Practice`:`Practice`,subtitle:`Choose your focus, then start questions.`,edgeToEdgeHeader:!0,edgeToEdgeMain:!0,children:(0,O.jsxs)(`div`,{className:`mx-auto w-full max-w-6xl space-y-5 sm:space-y-6`,children:[(0,O.jsxs)(T,{className:`practice-card`,children:[(0,O.jsx)(`div`,{className:`practice-card-header`,children:(0,O.jsx)(`p`,{className:`practice-card-header-title`,children:`Practice setup`})}),(0,O.jsxs)(w,{className:`flex flex-col gap-4 bg-[#f3f4f6]/30 px-4 py-5 sm:px-7 sm:py-6 lg:flex-row lg:items-center lg:justify-between lg:gap-6`,children:[(0,O.jsxs)(`div`,{className:`min-w-0`,children:[(0,O.jsx)(`p`,{className:`font-display text-lg font-semibold tracking-tight text-[#0b0f19] sm:text-xl`,children:_?.name??`Subject`}),(0,O.jsx)(`p`,{className:`mt-1 text-sm leading-relaxed text-muted-foreground`,children:`Pick a topic / section, then start questions.`})]}),(0,O.jsxs)(`div`,{className:`flex w-full flex-col gap-3 sm:flex-row sm:items-end sm:justify-end lg:gap-3`,children:[v?(0,O.jsxs)(`div`,{className:`flex items-center gap-2 rounded-xl border border-black/8 bg-[#f3f4f6] px-4 py-3 text-sm text-muted-foreground`,children:[(0,O.jsx)(oe,{className:`size-4 animate-spin`}),`Loading…`]}):A?(0,O.jsxs)(`div`,{className:`w-full min-w-0 space-y-2 sm:min-w-[260px]`,children:[(0,O.jsx)(`p`,{className:`text-[0.6875rem] font-semibold uppercase tracking-[0.12em] text-muted-foreground`,children:`English section`}),(0,O.jsxs)(p,{value:F,onValueChange:e=>I(e??`A`),children:[(0,O.jsx)(u,{className:`h-11 rounded-xl border-brand-light/50 bg-brand-light/50 text-[#0b0f19]`,children:(0,O.jsx)(l,{placeholder:`Choose section`})}),(0,O.jsxs)(d,{alignItemWithTrigger:!1,children:[(0,O.jsx)(f,{value:`A`,children:`Section A — Text response`}),(0,O.jsx)(f,{value:`B`,children:`Section B — Creative`}),(0,O.jsx)(f,{value:`C`,children:`Section C — Writing`})]})]})]}):(0,O.jsxs)(`div`,{className:`w-full min-w-0 space-y-2 sm:min-w-[260px]`,children:[(0,O.jsx)(`p`,{className:`text-[0.6875rem] font-semibold uppercase tracking-[0.12em] text-muted-foreground`,children:`Topic`}),(0,O.jsxs)(p,{value:N,onValueChange:e=>P(e??`all`),children:[(0,O.jsx)(u,{className:`h-11 rounded-xl border-brand-light/50 bg-brand-light/50 text-[#0b0f19]`,children:(0,O.jsx)(l,{placeholder:`Choose topic`})}),(0,O.jsx)(d,{alignItemWithTrigger:!1,className:`max-h-72`,children:B.map(e=>(0,O.jsx)(f,{value:e,children:e===`all`?`All topics`:e},e))})]})]}),(0,O.jsxs)(ee,{variant:`accent`,onClick:()=>{if(t){if(A){o(`/quiz/english?section=${encodeURIComponent(F)}`);return}o(`/quiz/${t}${N&&N!==`all`?`?topic=${encodeURIComponent(N)}`:``}`)}},className:`h-11 w-full gap-2 rounded-xl sm:w-auto`,children:[(0,O.jsx)(ae,{className:`size-4`}),`Questions`,(0,O.jsx)(m,{className:`size-4`})]})]})]})]}),(0,O.jsxs)(T,{className:`practice-card`,children:[(0,O.jsx)(`div`,{className:`practice-card-header`,children:(0,O.jsx)(`p`,{className:`practice-card-header-title`,children:`Study overview`})}),(0,O.jsx)(w,{className:`px-4 py-5 sm:px-7 sm:py-6`,children:V?(0,O.jsx)(k,{markdown:V}):(0,O.jsx)(`div`,{className:`rounded-2xl border border-dashed border-black/15 bg-[#0b0f19]/[0.03] p-8 text-center`,children:(0,O.jsx)(`p`,{className:`text-sm font-medium text-muted-foreground`,children:`Choose a topic above to load overview notes.`})})})]})]})})}export{Ie as default};