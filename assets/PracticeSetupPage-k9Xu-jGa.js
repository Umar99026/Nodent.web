...
${F}`)};function B(e){let t=String(e??``).trim();if(!t)return null;let n=g(t);if(Object.prototype.hasOwnProperty.call(z,n))return z[n];let r=I(n),i=L[r]??L[I(t)];if(i)return z[i]??null;for(let e of v)if(I(e)===r||I(e)===I(t))return z[e];return null}var V=`A function takes an input $x$ and gives exactly one output $y$: $y = f(x)$.
...
${n}`}var J={"Functions and transformations":q(`## Functions and transformations`,`Functions, relations and graphs`,V),"Polynomial, power and rational functions":q(`## Polynomial, power and rational functions`,`Functions, relations and graphs`,H),"Exponential and logarithmic functions":q(`## Exponential and logarithmic functions`,`Functions, relations and graphs`,U),"Circular functions":q(`## Circular functions`,`Functions, relations and graphs`,W),"Algebra and equations":q(`## Algebra and equations`,`Algebra`,pe),"Differential calculus":q(`## Differential calculus`,`Calculus`,me),"Applications of differentiation":q(`## Applications of differentiation`,`Calculus`,he),"Integral calculus":q(`## Integral calculus`,`Calculus`,ge),"Applications of integration":q(`## Applications of integration`,`Calculus`,_e),"Discrete random variables":q(`## Discrete random variables`,`Probability and statistics`,ve),"Continuous random variables":q(`## Continuous random variables`,`Probability and statistics`,ye),"The normal distribution":q(`## The normal distribution`,`Probability and statistics`,be),"Sampling and sample proportions":q(`## Sampling and sample proportions`,`Probability and statistics`,xe),"Confidence intervals for proportions":q(`## Confidence intervals for proportions`,`Probability and statistics`,Se)};function Ce(e){let t=String(e??``).trim();if(!t)return null;let n=S(t);if(Object.prototype.hasOwnProperty.call(J,n))return J[n];let r=G(n),i=K[r]??K[G(t)];if(i)return J[i]??null;for(let e of _)if(G(e)===r||G(e)===G(t))return J[e];return null}var we=`### Logic and statements
...
${Fe}`)};function Ie(e){let t=String(e??``).trim();if(!t)return null;let n=C(t);if(Object.prototype.hasOwnProperty.call(Q,n))return Q[n];let r=Y(n),i=X[r]??X[Y(t)];if(i)return Q[i]??null;for(let e of w)if(Y(e)===r||Y(e)===Y(t))return Q[e];return null}function Le(e){return/math|methods|specialist|further/i.test(e)}function Re(e){return e===`A`?`### Section A — Analytical response to a text
