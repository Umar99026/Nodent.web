import{$ as e,Q as t,W as n,Z as r,it as i,t as a,tt as o}from"./button-DFrmYp0H.js";import{_ as s,f as ee,i as te,m as ne,p as re,r as ie}from"./api-D8WnSJQ8.js";import{dt as c}from"./composite-Dl6_FPSv.js";import{t as l}from"./AppShell-OpzloeQN.js";import{n as u}from"./utils-C4pgb95X.js";import{t as d}from"./book-open-BrznTQBU.js";import{a as f,i as ae,n as oe,r as p,t as se}from"./select-DCJeLnyo.js";import{t as ce}from"./file-text-CjCIiWVJ.js";import{s as le,u as m}from"./index-DCTblvo3.js";import{S as h,_ as ue,b as de,d as g,h as _,m as v,o as y,p as b,r as x,v as S,y as C}from"./practiceQuestions-37gzJp1O.js";import{n as w}from"./questionBankCache-Dv_6Fo_u.js";import{n as T,t as E}from"./card-CrIL5aoq.js";import{n as fe,t as pe}from"./subjects-CXiALAqT.js";import{t as D}from"./RichQuestionContent-CUYiGNof.js";import{t as me}from"./TopicPerformanceSelect-DMnan1ck.js";var O=i(o(),1),k=n();function he({markdown:e,className:t}){return(0,k.jsx)(`div`,{className:u(`curriculum-overview relative overflow-hidden rounded-2xl`,`border border-black/10 border-l-4 border-l-brand-light/70 bg-[#f3f4f6]/50`,`px-5 py-7 sm:rounded-3xl sm:px-8 sm:py-9`,`text-[#0b0f19] antialiased`,`[&_.katex-error]:hidden`,`[&_a]:font-medium [&_a]:text-brand-deep [&_a]:underline [&_a]:decoration-brand/45 [&_a]:decoration-1 [&_a]:underline-offset-[3px] [&_a]:transition-colors hover:[&_a]:text-brand hover:[&_a]:decoration-brand`,t),children:(0,k.jsx)(D,{text:e,preferMarkdown:!0,overviewMode:!0})})}var A=`### Types of data
...
${N}`)};function R(e){let t=String(e??``).trim();if(!t)return null;let n=h(t);if(Object.prototype.hasOwnProperty.call(L,n))return L[n];let r=P(n),i=F[r]??F[P(t)];if(i)return L[i]??null;for(let e of C)if(P(e)===r||P(e)===P(t))return L[e];return null}var z=`A function takes an input $x$ and gives exactly one output $y$: $y = f(x)$.
...
`,ge=`Calculus studies **change** (differentiation) and **accumulation** (integration).
...
${n}`}var J={"Functions and transformations":q(`## Functions and transformations`,`Functions, relations and graphs`,z),"Polynomial, power and rational functions":q(`## Polynomial, power and rational functions`,`Functions, relations and graphs`,B),"Exponential and logarithmic functions":q(`## Exponential and logarithmic functions`,`Functions, relations and graphs`,V),"Circular functions":q(`## Circular functions`,`Functions, relations and graphs`,H),"Algebra and equations":q(`## Algebra and equations`,`Algebra`,U),"Differential calculus":q(`## Differential calculus`,`Calculus`,ge),"Applications of differentiation":q(`## Applications of differentiation`,`Calculus`,_e),"Integral calculus":q(`## Integral calculus`,`Calculus`,ve),"Applications of integration":q(`## Applications of integration`,`Calculus`,ye),"Discrete random variables":q(`## Discrete random variables`,`Probability and statistics`,be),"Continuous random variables":q(`## Continuous random variables`,`Probability and statistics`,W),"The normal distribution":q(`## The normal distribution`,`Probability and statistics`,xe),"Sampling and sample proportions":q(`## Sampling and sample proportions`,`Probability and statistics`,Se),"Confidence intervals for proportions":q(`## Confidence intervals for proportions`,`Probability and statistics`,Ce)};function we(e){let t=String(e??``).trim();if(!t)return null;let n=S(t);if(Object.prototype.hasOwnProperty.call(J,n))return J[n];let r=G(n),i=K[r]??K[G(t)];if(i)return J[i]??null;for(let e of _)if(G(e)===r||G(e)===G(t))return J[e];return null}var Te=`### Logic and statements
...
**Subject:** Mathematical Methods`:e.subjectId===`general-maths`||e.subjectId===`demo`?R(n)||`### ${n}
...
- Not linking evidence back to the question wording`}function Be(e){return Array.from(new Set(e.map(e=>e.trim()).filter(Boolean))).sort((e,t)=>e.localeCompare(t))}function Ve(){let{subjectId:n}=t(),i=r(),{user:o}=c(),u=s(o),h=ne(o),[g]=e();(0,O.useEffect)(()=>{String(n)===`demo`&&!u&&i(`/dashboard`,{replace:!0})},[n,u,i]);let _=(0,O.useMemo)(()=>u?fe({isAdmin:u}):pe,[u]),v=(0,O.useMemo)(()=>_.find(e=>String(e.id)===String(n)),[_,n]),[S,C]=(0,O.useState)(!0),[D,A]=(0,O.useState)([]),j=String(n)===`english`,M=String(g.get(`topic`)??`all`),N=String(g.get(`section`)??`A`).toUpperCase()||`A`,[P,F]=(0,O.useState)(M||`all`),[I,L]=(0,O.useState)(N===`B`||N===`C`?N:`A`);(0,O.useEffect)(()=>{if(!n)return;let e=!1,t=w(n);if(t.length>0)A(t),C(!1);else if(o)C(!0);else{A(y([],n)),C(!1);return}if(o)return(async()=>{try{let t=await te(ee.bootstrap,{timeoutMs:ie});if(e)return;t.customQuestions&&localStorage.setItem(re.customQuestions,JSON.stringify(t.customQuestions)),A(y(x(t.customQuestions,n),n))}catch{if(e)return;A(w(n))}finally{e||C(!1)}})(),()=>{e=!0}},[n,o]);let R=String(n)===`methods`,z=String(n)===`general-maths`||String(n)===`demo`,B=String(n)===`specialist-maths`,V=(0,O.useMemo)(()=>j?[]:R?ue():z?de():B?b():[`all`,...Be(D.map(e=>e.topic??`General`))],[D,j,R,z,B]),H=(0,O.useMemo)(()=>V.filter(e=>e!==`all`),[V]),U=(0,O.useMemo)(()=>n?j?$({subjectId:n,subject:v,topic:P,englishSection:I}):!P||P===`all`?null:$({subjectId:n,subject:v,topic:P,englishSection:I}):null,[n,v,P,I,j]);return(0,O.useEffect)(()=>{j||V.length&&!V.includes(P)&&F(`all`)},[V,P,j]),(0,k.jsx)(l,{title:v?`${v.name} Practice`:`Practice`,subtitle:`Choose your focus, then start questions.`,edgeToEdgeHeader:!0,edgeToEdgeMain:!0,children:(0,k.jsxs)(`div`,{className:`mx-auto w-full max-w-6xl space-y-5 sm:space-y-6`,children:[(0,k.jsxs)(E,{className:`practice-card`,children:[(0,k.jsx)(`div`,{className:`practice-card-header`,children:(0,k.jsx)(`p`,{className:`practice-card-header-title`,children:`Practice setup`})}),(0,k.jsxs)(T,{className:`flex flex-col gap-4 bg-[#f3f4f6]/30 px-4 py-5 sm:px-7 sm:py-6 lg:flex-row lg:items-center lg:justify-between lg:gap-6`,children:[(0,k.jsxs)(`div`,{className:`min-w-0`,children:[(0,k.jsx)(`p`,{className:`font-display text-lg font-semibold tracking-tight text-[#0b0f19] sm:text-xl`,children:v?.name??`Subject`}),(0,k.jsx)(`p`,{className:`mt-1 text-sm leading-relaxed text-muted-foreground`,children:`Pick a topic / section, then start questions.`})]}),(0,k.jsxs)(`div`,{className:`flex w-full flex-col gap-3 sm:flex-row sm:items-end sm:justify-end lg:gap-3`,children:[S?(0,k.jsxs)(`div`,{className:`flex items-center gap-2 rounded-xl border border-black/8 bg-[#f3f4f6] px-4 py-3 text-sm text-muted-foreground`,children:[(0,k.jsx)(le,{className:`size-4 animate-spin`}),`Loading…`]}):j?(0,k.jsxs)(`div`,{className:`w-full min-w-0 space-y-2 sm:min-w-[260px]`,children:[(0,k.jsx)(`p`,{className:`text-[0.6875rem] font-semibold uppercase tracking-[0.12em] text-muted-foreground`,children:`English section`}),(0,k.jsxs)(se,{value:I,onValueChange:e=>L(e??`A`),children:[(0,k.jsx)(ae,{className:`h-11 rounded-xl border-brand-light/50 bg-brand-light/50 text-[#0b0f19]`,children:(0,k.jsx)(f,{placeholder:`Choose section`})}),(0,k.jsxs)(oe,{alignItemWithTrigger:!1,children:[(0,k.jsx)(p,{value:`A`,children:`Section A — Text response`}),(0,k.jsx)(p,{value:`B`,children:`Section B — Creative`}),(0,k.jsx)(p,{value:`C`,children:`Section C — Writing`})]})]})]}):(0,k.jsxs)(`div`,{className:`w-fit min-w-0 space-y-2`,children:[(0,k.jsx)(`p`,{className:`text-[0.6875rem] font-semibold uppercase tracking-[0.12em] text-muted-foreground`,children:`Topic`}),(0,k.jsx)(me,{subjectId:n,value:P,onValueChange:F,topics:H,includeAllOption:!0,placeholder:`Choose topic`})]}),(0,k.jsxs)(`div`,{className:`flex w-full flex-col gap-2 sm:w-auto sm:flex-row`,children:[h?(0,k.jsxs)(a,{type:`button`,variant:`outline`,onClick:()=>i(`/practice/${n}/exams`),className:`h-11 w-full gap-2 rounded-xl sm:w-auto`,children:[(0,k.jsx)(ce,{className:`size-4`}),`Exams`,(0,k.jsx)(m,{className:`size-4`})]}):null,(0,k.jsxs)(a,{variant:`accent`,onClick:()=>{if(n){if(j){i(`/quiz/english?section=${encodeURIComponent(I)}`);return}i(`/quiz/${n}${P&&P!==`all`?`?topic=${encodeURIComponent(P)}`:``}`)}},className:`h-11 w-full gap-2 rounded-xl sm:w-auto`,children:[(0,k.jsx)(d,{className:`size-4`}),`Questions`,(0,k.jsx)(m,{className:`size-4`})]})]})]})]})]}),(0,k.jsxs)(E,{className:`practice-card`,children:[(0,k.jsx)(`div`,{className:`practice-card-header`,children:(0,k.jsx)(`p`,{className:`practice-card-header-title`,children:`Study overview`})}),(0,k.jsx)(T,{className:`px-4 py-5 sm:px-7 sm:py-6`,children:U?(0,k.jsx)(he,{markdown:U}):(0,k.jsx)(`div`,{className:`rounded-2xl border border-dashed border-black/15 bg-[#0b0f19]/[0.03] p-8 text-center`,children:(0,k.jsx)(`p`,{className:`text-sm font-medium text-muted-foreground`,children:`Choose a topic above to load overview notes.`})})})]})]})})}export{Ve as default};